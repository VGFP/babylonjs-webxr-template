...
[@babylonjs/root](../../../README.md) / [gui/src](../README.md) / PlanePanel

# Class: PlanePanel

Defined in: [babylonjs-source/packages/dev/gui/src/3D/controls/planePanel.ts:10](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/gui/src/3D/controls/planePanel.ts#L10)
...
> **new PlanePanel**(`name?`): `PlanePanel`
