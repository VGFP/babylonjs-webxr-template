...
[@babylonjs/root](../../../README.md) / [gui/src](../README.md) / StackPanel

# Class: StackPanel

Defined in: [babylonjs-source/packages/dev/gui/src/2D/controls/stackPanel.ts:13](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/gui/src/2D/controls/stackPanel.ts#L13)
...
> **new StackPanel**(`name?`): `StackPanel`
