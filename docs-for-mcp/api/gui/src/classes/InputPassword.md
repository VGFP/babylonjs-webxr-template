...
Defined in: [babylonjs-source/packages/dev/gui/src/2D/controls/inputPassword.ts:8](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/gui/src/2D/controls/inputPassword.ts#L8)
