...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / DecalBuilder

# ~~Variable: DecalBuilder~~

> `const` **DecalBuilder**: `object`

Defined in: [babylonjs-source/packages/dev/core/src/Meshes/Builders/decalBuilder.pure.ts:557](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Meshes/Builders/decalBuilder.pure.ts#L557)
