...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / ShapeBuilder

# ~~Variable: ShapeBuilder~~

> `const` **ShapeBuilder**: `object`

Defined in: [babylonjs-source/packages/dev/core/src/Meshes/Builders/shapeBuilder.pure.ts:373](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Meshes/Builders/shapeBuilder.pure.ts#L373)
