...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / TiledBoxBuilder

# ~~Variable: TiledBoxBuilder~~

> `const` **TiledBoxBuilder**: `object`

Defined in: [babylonjs-source/packages/dev/core/src/Meshes/Builders/tiledBoxBuilder.ts:277](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Meshes/Builders/tiledBoxBuilder.ts#L277)
