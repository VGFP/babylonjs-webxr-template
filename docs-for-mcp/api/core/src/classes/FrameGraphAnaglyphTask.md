...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FrameGraphAnaglyphTask

# Class: FrameGraphAnaglyphTask

Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/anaglyphTask.ts:8](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/anaglyphTask.ts#L8)
...
> **new FrameGraphAnaglyphTask**(`name`, `frameGraph`, `thinPostProcess?`): `FrameGraphAnaglyphTask`

Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/anaglyphTask.ts:22](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/anaglyphTask.ts#L22)
...
The thin post process to use for the anaglyph effect. If not provided, a new one will be created.
...
[`FrameGraphCustomPostProcessTask`](FrameGraphCustomPostProcessTask.md).[`depthReadOnly`](FrameGraphCustomPostProcessTask.md#depthreadonly)
...
[`FrameGraphCustomPostProcessTask`](FrameGraphCustomPostProcessTask.md).[`depthTest`](FrameGraphCustomPostProcessTask.md#depthtest)
...
[`FrameGraphCustomPostProcessTask`](FrameGraphCustomPostProcessTask.md).[`disableColorWrite`](FrameGraphCustomPostProcessTask.md#disablecolorwrite)
...
[`FrameGraphCustomPostProcessTask`](FrameGraphCustomPostProcessTask.md).[`drawBackFace`](FrameGraphCustomPostProcessTask.md#drawbackface)
...
Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/anaglyphTask.ts:12](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/anaglyphTask.ts#L12)
...
> `readonly` **postProcess**: [`ThinAnaglyphPostProcess`](ThinAnaglyphPostProcess.md)

Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/anaglyphTask.ts:14](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/anaglyphTask.ts#L14)
...
[`FrameGraphCustomPostProcessTask`](FrameGraphCustomPostProcessTask.md).[`sourceSamplingMode`](FrameGraphCustomPostProcessTask.md#sourcesamplingmode)
...
[`FrameGraphCustomPostProcessTask`](FrameGraphCustomPostProcessTask.md).[`stencilReadOnly`](FrameGraphCustomPostProcessTask.md#stencilreadonly)
...
Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/postProcessTask.ts:243](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/postProcessTask.ts#L243)
...
Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/anaglyphTask.ts:26](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/anaglyphTask.ts#L26)
...
Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/anaglyphTask.ts:30](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/anaglyphTask.ts#L30)
