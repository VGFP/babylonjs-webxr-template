...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphRotate3DBlock

# Class: FlowGraphRotate3DBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:138](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L138)

3D rotation block.

## Extends

- `FlowGraphBinaryOperationBlock`\<[`Vector3`](Vector3.md), [`Quaternion`](Quaternion.md), [`Vector3`](Vector3.md)\>

## Constructors

### Constructor

> **new FlowGraphRotate3DBlock**(`config?`): `FlowGraphRotate3DBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:139](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L139)
...
`FlowGraphBinaryOperationBlock<Vector3, Quaternion, Vector3>.constructor`
