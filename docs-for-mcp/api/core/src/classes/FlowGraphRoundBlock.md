...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphRoundBlock

# Class: FlowGraphRoundBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:468](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L468)

Round block.

## Extends

- `FlowGraphUnaryOperationBlock`\<`FlowGraphMathOperationType`, `FlowGraphMathOperationType`\>

## Constructors

### Constructor

> **new FlowGraphRoundBlock**(`config?`): `FlowGraphRoundBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:469](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L469)
...
`FlowGraphUnaryOperationBlock<FlowGraphMathOperationType, FlowGraphMathOperationType>.constructor`
