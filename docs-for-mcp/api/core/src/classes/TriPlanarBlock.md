...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / TriPlanarBlock

# Class: TriPlanarBlock

Defined in: [babylonjs-source/packages/dev/core/src/Materials/Node/Blocks/triPlanarBlock.pure.ts:26](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Materials/Node/Blocks/triPlanarBlock.pure.ts#L26)
...
- [`BiPlanarBlock`](BiPlanarBlock.md)

## Constructors

### Constructor

> **new TriPlanarBlock**(`name`, `hideSourceZ?`): `TriPlanarBlock`

Defined in: [babylonjs-source/packages/dev/core/src/Materials/Node/Blocks/triPlanarBlock.pure.ts:182](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Materials/Node/Blocks/triPlanarBlock.pure.ts#L182)
...
defines a boolean indicating that normal Z should not be used (false by default)
...
> **connectTo**(`other`, `options?`): `TriPlanarBlock` \| `undefined`
...
Defined in: [babylonjs-source/packages/dev/core/src/Materials/Node/Blocks/triPlanarBlock.pure.ts:255](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Materials/Node/Blocks/triPlanarBlock.pure.ts#L255)
...
> **registerInput**(`name`, `type`, `isOptional?`, `target?`, `point?`): `TriPlanarBlock`
...
> **registerOutput**(`name`, `type`, `target?`, `point?`): `TriPlanarBlock`
