...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphDeterminantBlock

# Class: FlowGraphDeterminantBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMatrixMathBlocks.pure.ts:54](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMatrixMathBlocks.pure.ts#L54)

Gets the determinant of a matrix.

## Extends

- `FlowGraphUnaryOperationBlock`\<`FlowGraphMatrix`, `number`\>

## Constructors

### Constructor

> **new FlowGraphDeterminantBlock**(`config?`): `FlowGraphDeterminantBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMatrixMathBlocks.pure.ts:59](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMatrixMathBlocks.pure.ts#L59)
...
`FlowGraphUnaryOperationBlock<FlowGraphMatrix, number>.constructor`
...
> `readonly` **value**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<`number`\>
