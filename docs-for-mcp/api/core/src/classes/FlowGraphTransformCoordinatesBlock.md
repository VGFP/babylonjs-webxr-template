...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphTransformCoordinatesBlock

# Class: FlowGraphTransformCoordinatesBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:197](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L197)

Transform a vector3 by a matrix.

## Extends

- `FlowGraphBinaryOperationBlock`\<[`Vector3`](Vector3.md), [`Matrix`](Matrix.md), [`Vector3`](Vector3.md)\>

## Constructors

### Constructor

> **new FlowGraphTransformCoordinatesBlock**(`config?`): `FlowGraphTransformCoordinatesBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:198](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L198)
...
`FlowGraphBinaryOperationBlock<Vector3, Matrix, Vector3>.constructor`

## Properties

### a

> **a**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<[`Vector3`](Vector3.md)\>
...
> **b**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<[`Matrix`](Matrix.md)\>
...
> **\_doOperation**(`context`): [`Vector3`](Vector3.md)
