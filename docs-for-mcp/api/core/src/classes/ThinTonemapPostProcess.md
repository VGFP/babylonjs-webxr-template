...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / ThinTonemapPostProcess

# Class: ThinTonemapPostProcess

Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/thinTonemapPostProcess.ts:32](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/PostProcesses/thinTonemapPostProcess.ts#L32)
...
> **new ThinTonemapPostProcess**(`name`, `engine?`, `options?`): `ThinTonemapPostProcess`

Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/thinTonemapPostProcess.ts:58](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/PostProcesses/thinTonemapPostProcess.ts#L58)
...
> **exposureAdjustment**: `number` = `1`

Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/thinTonemapPostProcess.ts:96](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/PostProcesses/thinTonemapPostProcess.ts#L96)
...
> `readonly` **operator**: [`TonemappingOperator`](../enumerations/TonemappingOperator.md) = `TonemappingOperator.Reinhard`

Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/thinTonemapPostProcess.ts:91](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/PostProcesses/thinTonemapPostProcess.ts#L91)
...
> `readonly` `static` **FragmentUrl**: `"tonemap"` = `"tonemap"`

Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/thinTonemapPostProcess.ts:36](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/PostProcesses/thinTonemapPostProcess.ts#L36)
...
Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/thinTonemapPostProcess.ts:41](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/PostProcesses/thinTonemapPostProcess.ts#L41)
...
Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/thinTonemapPostProcess.ts:98](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/PostProcesses/thinTonemapPostProcess.ts#L98)
