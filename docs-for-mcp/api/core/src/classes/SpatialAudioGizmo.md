...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / SpatialAudioGizmo

# Class: SpatialAudioGizmo

Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/spatialAudioGizmo.ts:32](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/spatialAudioGizmo.ts#L32)
...
- [`ISpatialAudioGizmo`](../interfaces/ISpatialAudioGizmo.md)

## Constructors

### Constructor

> **new SpatialAudioGizmo**(`gizmoLayer?`): `SpatialAudioGizmo`

Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/spatialAudioGizmo.ts:47](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/spatialAudioGizmo.ts#L47)
...
[`ISpatialAudioGizmo`](../interfaces/ISpatialAudioGizmo.md).[`_rootMesh`](../interfaces/ISpatialAudioGizmo.md#_rootmesh)
...
[`ISpatialAudioGizmo`](../interfaces/ISpatialAudioGizmo.md).[`gizmoLayer`](../interfaces/ISpatialAudioGizmo.md#gizmolayer)
...
> `readonly` **onClickedObservable**: [`Observable`](Observable.md)\<[`AbstractSoundSource`](AbstractSoundSource.md)\>

Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/spatialAudioGizmo.ts:41](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/spatialAudioGizmo.ts#L41)

Event that fires each time the gizmo is clicked.

#### Implementation of

[`ISpatialAudioGizmo`](../interfaces/ISpatialAudioGizmo.md).[`onClickedObservable`](../interfaces/ISpatialAudioGizmo.md#onclickedobservable)
...
[`ISpatialAudioGizmo`](../interfaces/ISpatialAudioGizmo.md).[`additionalTransformNode`](../interfaces/ISpatialAudioGizmo.md#additionaltransformnode)
...
[`ISpatialAudioGizmo`](../interfaces/ISpatialAudioGizmo.md).[`anchorPoint`](../interfaces/ISpatialAudioGizmo.md#anchorpoint)
...
[`ISpatialAudioGizmo`](../interfaces/ISpatialAudioGizmo.md).[`attachedMesh`](../interfaces/ISpatialAudioGizmo.md#attachedmesh)
...
[`ISpatialAudioGizmo`](../interfaces/ISpatialAudioGizmo.md).[`attachedNode`](../interfaces/ISpatialAudioGizmo.md#attachednode)
...
[`ISpatialAudioGizmo`](../interfaces/ISpatialAudioGizmo.md).[`coordinatesMode`](../interfaces/ISpatialAudioGizmo.md#coordinatesmode)
...
[`ISpatialAudioGizmo`](../interfaces/ISpatialAudioGizmo.md).[`customRotationQuaternion`](../interfaces/ISpatialAudioGizmo.md#customrotationquaternion)
...
[`ISpatialAudioGizmo`](../interfaces/ISpatialAudioGizmo.md).[`isHovered`](../interfaces/ISpatialAudioGizmo.md#ishovered)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/spatialAudioGizmo.ts:104](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/spatialAudioGizmo.ts#L104)
...
[`ISpatialAudioGizmo`](../interfaces/ISpatialAudioGizmo.md).[`material`](../interfaces/ISpatialAudioGizmo.md#material)
...
[`ISpatialAudioGizmo`](../interfaces/ISpatialAudioGizmo.md).[`scaleRatio`](../interfaces/ISpatialAudioGizmo.md#scaleratio)
...
> **get** **soundSource**(): [`Nullable`](../type-aliases/Nullable.md)\<[`AbstractSoundSource`](AbstractSoundSource.md)\>

Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/spatialAudioGizmo.ts:85](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/spatialAudioGizmo.ts#L85)

The sound source the gizmo is attached to.

##### Returns

[`Nullable`](../type-aliases/Nullable.md)\<[`AbstractSoundSource`](AbstractSoundSource.md)\>

#### Set Signature

> **set** **soundSource**(`soundSource`): `void`

Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/spatialAudioGizmo.ts:89](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/spatialAudioGizmo.ts#L89)
...
[`ISpatialAudioGizmo`](../interfaces/ISpatialAudioGizmo.md).[`soundSource`](../interfaces/ISpatialAudioGizmo.md#soundsource)
...
[`ISpatialAudioGizmo`](../interfaces/ISpatialAudioGizmo.md).[`updateGizmoPositionToMatchAttachedMesh`](../interfaces/ISpatialAudioGizmo.md#updategizmopositiontomatchattachedmesh)
...
[`ISpatialAudioGizmo`](../interfaces/ISpatialAudioGizmo.md).[`updateGizmoRotationToMatchAttachedMesh`](../interfaces/ISpatialAudioGizmo.md#updategizmorotationtomatchattachedmesh)
...
[`ISpatialAudioGizmo`](../interfaces/ISpatialAudioGizmo.md).[`updateScale`](../interfaces/ISpatialAudioGizmo.md#updatescale)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/spatialAudioGizmo.ts:158](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/spatialAudioGizmo.ts#L158)
...
[`ISpatialAudioGizmo`](../interfaces/ISpatialAudioGizmo.md).[`dispose`](../interfaces/ISpatialAudioGizmo.md#dispose)
...
[`ISpatialAudioGizmo`](../interfaces/ISpatialAudioGizmo.md).[`setCustomMesh`](../interfaces/ISpatialAudioGizmo.md#setcustommesh)
