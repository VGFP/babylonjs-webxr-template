...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphSetPropertyBlock

# Class: FlowGraphSetPropertyBlock\<P, O\>

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Execution/flowGraphSetPropertyBlock.ts:32](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Execution/flowGraphSetPropertyBlock.ts#L32)
...
> **new FlowGraphSetPropertyBlock**\<`P`, `O`\>(`config`): `FlowGraphSetPropertyBlock`\<`P`, `O`\>

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Execution/flowGraphSetPropertyBlock.ts:54](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Execution/flowGraphSetPropertyBlock.ts#L54)

#### Parameters

##### config

[`IFlowGraphSetPropertyBlockConfiguration`](../interfaces/IFlowGraphSetPropertyBlockConfiguration.md)\<`O`\>

the configuration of the block

#### Returns

`FlowGraphSetPropertyBlock`\<`P`, `O`\>
...
> **config**: [`IFlowGraphSetPropertyBlockConfiguration`](../interfaces/IFlowGraphSetPropertyBlockConfiguration.md)\<`O`\>

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Execution/flowGraphSetPropertyBlock.ts:58](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Execution/flowGraphSetPropertyBlock.ts#L58)
...
> `readonly` **customSetFunction**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<(`target`, `propertyName`, `value`, `context`) => `void`\>

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Execution/flowGraphSetPropertyBlock.ts:52](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Execution/flowGraphSetPropertyBlock.ts#L52)
...
Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Execution/flowGraphSetPropertyBlock.ts:41](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Execution/flowGraphSetPropertyBlock.ts#L41)
...
Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Execution/flowGraphSetPropertyBlock.ts:46](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Execution/flowGraphSetPropertyBlock.ts#L46)
...
Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Execution/flowGraphSetPropertyBlock.ts:36](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Execution/flowGraphSetPropertyBlock.ts#L36)
...
Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Execution/flowGraphSetPropertyBlock.ts:120](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Execution/flowGraphSetPropertyBlock.ts#L120)
