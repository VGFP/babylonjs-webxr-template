...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / ShadowLight

# Abstract Class: ShadowLight

Defined in: [babylonjs-source/packages/dev/core/src/Lights/shadowLight.ts:125](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Lights/shadowLight.ts#L125)
...
> **new ShadowLight**(`name`, `scene?`, `dontAddToScene?`): `ShadowLight`

Defined in: [babylonjs-source/packages/dev/core/src/Lights/light.ts:388](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Lights/light.ts#L388)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`onAccessibilityTagChangedObservable`](../interfaces/IShadowLight.md#onaccessibilitytagchangedobservable)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`accessibilityTag`](../interfaces/IShadowLight.md#accessibilitytag)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`animationPropertiesOverride`](../interfaces/IShadowLight.md#animationpropertiesoverride)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`behaviors`](../interfaces/IShadowLight.md#behaviors)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`doNotSerialize`](../interfaces/IShadowLight.md#donotserialize)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`excludedMeshes`](../interfaces/IShadowLight.md#excludedmeshes)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`excludeWithLayerMask`](../interfaces/IShadowLight.md#excludewithlayermask)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`includedOnlyMeshes`](../interfaces/IShadowLight.md#includedonlymeshes)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`includeOnlyWithLayerMask`](../interfaces/IShadowLight.md#includeonlywithlayermask)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`inheritVisibility`](../interfaces/IShadowLight.md#inheritvisibility)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`intensityMode`](../interfaces/IShadowLight.md#intensitymode)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`isVisible`](../interfaces/IShadowLight.md#isvisible)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`lightmapMode`](../interfaces/IShadowLight.md#lightmapmode)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`onClonedObservable`](../interfaces/IShadowLight.md#onclonedobservable)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`onDispose`](../interfaces/IShadowLight.md#ondispose)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`onEnabledStateChangedObservable`](../interfaces/IShadowLight.md#onenabledstatechangedobservable)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`parent`](../interfaces/IShadowLight.md#parent)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`radius`](../interfaces/IShadowLight.md#radius)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`range`](../interfaces/IShadowLight.md#range)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`shadowEnabled`](../interfaces/IShadowLight.md#shadowenabled)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`worldMatrixFromCache`](../interfaces/IShadowLight.md#worldmatrixfromcache)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`areLightTexturesReady`](../interfaces/IShadowLight.md#arelighttexturesready)
...
Defined in: [babylonjs-source/packages/dev/core/src/Lights/shadowLight.ts:373](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Lights/shadowLight.ts#L373)
...
Defined in: [babylonjs-source/packages/dev/core/src/Lights/shadowLight.ts:364](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Lights/shadowLight.ts#L364)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`getProjectionMatrix`](../interfaces/IShadowLight.md#getprojectionmatrix)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`getShadowGenerators`](../interfaces/IShadowLight.md#getshadowgenerators)
...
[`IShadowLight`](../interfaces/IShadowLight.md).[`getViewMatrix`](../interfaces/IShadowLight.md#getviewmatrix)
