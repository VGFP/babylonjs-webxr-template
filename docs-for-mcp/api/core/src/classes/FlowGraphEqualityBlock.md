...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphEqualityBlock

# Class: FlowGraphEqualityBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:692](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L692)

Equals block.

## Extends

- `FlowGraphBinaryOperationBlock`\<`FlowGraphMathOperationType`, `FlowGraphMathOperationType`, `boolean`\>

## Constructors

### Constructor

> **new FlowGraphEqualityBlock**(`config?`): `FlowGraphEqualityBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:693](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L693)
...
`FlowGraphBinaryOperationBlock<FlowGraphMathOperationType, FlowGraphMathOperationType, boolean>.constructor`
