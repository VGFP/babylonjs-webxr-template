...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphRotate2DBlock

# Class: FlowGraphRotate2DBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:129](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L129)

2D rotation block.

## Extends

- `FlowGraphBinaryOperationBlock`\<[`Vector2`](Vector2.md), `number`, [`Vector2`](Vector2.md)\>

## Constructors

### Constructor

> **new FlowGraphRotate2DBlock**(`config?`): `FlowGraphRotate2DBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:130](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L130)
...
`FlowGraphBinaryOperationBlock<Vector2, number, Vector2>.constructor`

## Properties

### a

> **a**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<[`Vector2`](Vector2.md)\>
...
> **b**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<`number`\>
...
> `readonly` **value**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<[`Vector2`](Vector2.md)\>
...
> **\_doOperation**(`context`): [`Vector2`](Vector2.md)
