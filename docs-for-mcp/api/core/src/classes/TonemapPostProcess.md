...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / TonemapPostProcess
...
[`Nullable`](../type-aliases/Nullable.md)\<[`Camera`](Camera.md)\> \| [`ToneMapPostProcessOptions`](../type-aliases/ToneMapPostProcessOptions.md)
...
defines the texture format to use (BABYLON.Engine.TEXTURETYPE_UNSIGNED_BYTE by default)
