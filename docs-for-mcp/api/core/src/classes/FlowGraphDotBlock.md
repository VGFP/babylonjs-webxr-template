...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphDotBlock

# Class: FlowGraphDotBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:97](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L97)

Dot product block.

## Extends

- `FlowGraphBinaryOperationBlock`\<`FlowGraphVector`, `FlowGraphVector`, `number`\>

## Constructors

### Constructor

> **new FlowGraphDotBlock**(`config?`): `FlowGraphDotBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:98](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L98)
...
`FlowGraphBinaryOperationBlock<FlowGraphVector, FlowGraphVector, number>.constructor`
...
> **b**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<`FlowGraphVector`\>
