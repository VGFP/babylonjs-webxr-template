...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / PlaneRotationGizmo

# Class: PlaneRotationGizmo

Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts:57](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts#L57)
...
> **new PlaneRotationGizmo**(`planeNormal`, `color?`, `gizmoLayer?`, `tessellation?`, `parent?`, `useEulerRotation?`, `thickness?`, `hoverColor?`, `disableColor?`): `PlaneRotationGizmo`

Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts:180](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts#L180)
...
[`Nullable`](../type-aliases/Nullable.md)\<[`RotationGizmo`](RotationGizmo.md)\> = `null`
...
[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`_rootMesh`](../interfaces/IPlaneRotationGizmo.md#_rootmesh)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts:83](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts#L83)

Accumulated relative angle value for rotation on the axis. Reset to 0 when a dragStart occurs

#### Implementation of

[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`angle`](../interfaces/IPlaneRotationGizmo.md#angle)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts:61](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts#L61)

Drag behavior responsible for the gizmos dragging interactions

#### Implementation of

[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`dragBehavior`](../interfaces/IPlaneRotationGizmo.md#dragbehavior)
...
[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`gizmoLayer`](../interfaces/IPlaneRotationGizmo.md#gizmolayer)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts:72](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts#L72)
...
[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`onSnapObservable`](../interfaces/IPlaneRotationGizmo.md#onsnapobservable)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts:88](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts#L88)

Custom sensitivity value for the drag strength

#### Implementation of

[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`sensitivity`](../interfaces/IPlaneRotationGizmo.md#sensitivity)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts:67](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts#L67)

Rotation distance in radians that the gizmo will snap to (Default: 0)

#### Implementation of

[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`snapDistance`](../interfaces/IPlaneRotationGizmo.md#snapdistance)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts:78](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts#L78)
...
[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`additionalTransformNode`](../interfaces/IPlaneRotationGizmo.md#additionaltransformnode)
...
[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`anchorPoint`](../interfaces/IPlaneRotationGizmo.md#anchorpoint)
...
[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`attachedMesh`](../interfaces/IPlaneRotationGizmo.md#attachedmesh)
...
[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`attachedNode`](../interfaces/IPlaneRotationGizmo.md#attachednode)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts:91](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts#L91)
...
[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`coloredMaterial`](../interfaces/IPlaneRotationGizmo.md#coloredmaterial)
...
[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`coordinatesMode`](../interfaces/IPlaneRotationGizmo.md#coordinatesmode)
...
[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`customRotationQuaternion`](../interfaces/IPlaneRotationGizmo.md#customrotationquaternion)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts:106](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts#L106)
...
[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`disableMaterial`](../interfaces/IPlaneRotationGizmo.md#disablematerial)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts:96](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts#L96)
...
[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`hoverMaterial`](../interfaces/IPlaneRotationGizmo.md#hovermaterial)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts:501](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts#L501)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts:490](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts#L490)
...
[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`isEnabled`](../interfaces/IPlaneRotationGizmo.md#isenabled)
...
[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`isHovered`](../interfaces/IPlaneRotationGizmo.md#ishovered)
...
> **set** **rotationColor**(`color`): `void`

Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts:101](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts#L101)
...
[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`rotationColor`](../interfaces/IPlaneRotationGizmo.md#rotationcolor)
...
[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`scaleRatio`](../interfaces/IPlaneRotationGizmo.md#scaleratio)
...
[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`updateGizmoPositionToMatchAttachedMesh`](../interfaces/IPlaneRotationGizmo.md#updategizmopositiontomatchattachedmesh)
...
[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`updateGizmoRotationToMatchAttachedMesh`](../interfaces/IPlaneRotationGizmo.md#updategizmorotationtomatchattachedmesh)
...
[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`updateScale`](../interfaces/IPlaneRotationGizmo.md#updatescale)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts:508](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Gizmos/planeRotationGizmo.pure.ts#L508)
...
[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`dispose`](../interfaces/IPlaneRotationGizmo.md#dispose)
...
[`IPlaneRotationGizmo`](../interfaces/IPlaneRotationGizmo.md).[`setCustomMesh`](../interfaces/IPlaneRotationGizmo.md#setcustommesh)
