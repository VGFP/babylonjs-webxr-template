...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphCombineMatrix2DBlock

# Class: FlowGraphCombineMatrix2DBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.pure.ts:208](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.pure.ts#L208)

Combines 4 floats into a new Matrix

## Extends

- `FlowGraphMathCombineBlock`\<[`FlowGraphMatrix2D`](FlowGraphMatrix2D.md)\>

## Constructors

### Constructor

> **new FlowGraphCombineMatrix2DBlock**(`config?`): `FlowGraphCombineMatrix2DBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.pure.ts:209](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.pure.ts#L209)
...
`FlowGraphMathCombineBlock<FlowGraphMatrix2D>.constructor`
...
> `readonly` **value**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<[`FlowGraphMatrix2D`](FlowGraphMatrix2D.md)\>
...
Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.pure.ts:236](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.pure.ts#L236)
