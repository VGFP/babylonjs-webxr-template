...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FrameGraphBlackAndWhiteTask

# Class: FrameGraphBlackAndWhiteTask

Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/blackAndWhiteTask.ts:8](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/blackAndWhiteTask.ts#L8)
...
> **new FrameGraphBlackAndWhiteTask**(`name`, `frameGraph`, `thinPostProcess?`): `FrameGraphBlackAndWhiteTask`

Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/blackAndWhiteTask.ts:17](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/blackAndWhiteTask.ts#L17)
...
The thin post process to use for the black and white effect. If not provided, a new one will be created.
...
> `readonly` **postProcess**: [`ThinBlackAndWhitePostProcess`](ThinBlackAndWhitePostProcess.md)

Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/blackAndWhiteTask.ts:9](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/blackAndWhiteTask.ts#L9)
...
Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/blackAndWhiteTask.ts:21](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/blackAndWhiteTask.ts#L21)
