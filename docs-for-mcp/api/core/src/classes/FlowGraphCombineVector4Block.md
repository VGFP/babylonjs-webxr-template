...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphCombineVector4Block

# Class: FlowGraphCombineVector4Block

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts:110](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts#L110)

Combines four floats into a new Vector4

## Extends

- `FlowGraphMathCombineBlock`\<[`Vector4`](Vector4.md)\>

## Constructors

### Constructor

> **new FlowGraphCombineVector4Block**(`config?`): `FlowGraphCombineVector4Block`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts:111](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts#L111)
...
`FlowGraphMathCombineBlock<Vector4>.constructor`
...
> `readonly` **value**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<[`Vector4`](Vector4.md)\>
...
Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts:129](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts#L129)
