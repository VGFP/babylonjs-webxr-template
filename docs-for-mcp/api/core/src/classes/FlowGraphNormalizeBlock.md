...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphNormalizeBlock

# Class: FlowGraphNormalizeBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:67](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L67)

Vector normalize block.

## Extends

- `FlowGraphUnaryOperationBlock`\<`FlowGraphVector`, `FlowGraphVector`\>

## Constructors

### Constructor

> **new FlowGraphNormalizeBlock**(`config?`): `FlowGraphNormalizeBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:68](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L68)
...
`FlowGraphUnaryOperationBlock<FlowGraphVector, FlowGraphVector>.constructor`
