...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / PhysicsShape

# Class: PhysicsShape

Defined in: [babylonjs-source/packages/dev/core/src/Physics/v2/physicsShape.ts:35](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Physics/v2/physicsShape.ts#L35)
...
- [`PhysicsShapeSphere`](PhysicsShapeSphere.md)
- [`PhysicsShapeCapsule`](PhysicsShapeCapsule.md)
- [`PhysicsShapeCylinder`](PhysicsShapeCylinder.md)
- [`PhysicsShapeBox`](PhysicsShapeBox.md)
- [`PhysicsShapeConvexHull`](PhysicsShapeConvexHull.md)
- [`PhysicsShapeMesh`](PhysicsShapeMesh.md)
- [`PhysicsShapeContainer`](PhysicsShapeContainer.md)
- [`PhysicsShapeHeightField`](PhysicsShapeHeightField.md)
- [`PhysicsShapeGroundMesh`](PhysicsShapeGroundMesh.md)

## Constructors

### Constructor

> **new PhysicsShape**(`options`, `scene`): `PhysicsShape`

Defined in: [babylonjs-source/packages/dev/core/src/Physics/v2/physicsShape.ts:66](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Physics/v2/physicsShape.ts#L66)
