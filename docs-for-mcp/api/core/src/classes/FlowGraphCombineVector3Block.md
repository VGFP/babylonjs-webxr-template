...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphCombineVector3Block

# Class: FlowGraphCombineVector3Block

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts:86](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts#L86)

Combines three floats into a new Vector3

## Extends

- `FlowGraphMathCombineBlock`\<[`Vector3`](Vector3.md)\>

## Constructors

### Constructor

> **new FlowGraphCombineVector3Block**(`config?`): `FlowGraphCombineVector3Block`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts:87](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts#L87)
...
`FlowGraphMathCombineBlock<Vector3>.constructor`
...
Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts:100](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts#L100)
