...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphIsInfinityBlock

# Class: FlowGraphIsInfinityBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:791](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L791)

Is Inf block.

## Extends

- `FlowGraphUnaryOperationBlock`\<`FlowGraphNumber`, `boolean`\>

## Constructors

### Constructor

> **new FlowGraphIsInfinityBlock**(`config?`): `FlowGraphIsInfinityBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:792](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L792)
...
`FlowGraphUnaryOperationBlock<FlowGraphNumber, boolean>.constructor`

## Properties

### a

> **a**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<`FlowGraphNumber`\>
