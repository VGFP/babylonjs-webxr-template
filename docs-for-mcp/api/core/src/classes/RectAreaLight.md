...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / RectAreaLight

# Class: RectAreaLight

Defined in: [babylonjs-source/packages/dev/core/src/Lights/rectAreaLight.pure.ts:20](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Lights/rectAreaLight.pure.ts#L20)
...
> **new RectAreaLight**(`name`, `position`, `width`, `height`, `scene?`, `dontAddToScene?`): `RectAreaLight`

Defined in: [babylonjs-source/packages/dev/core/src/Lights/rectAreaLight.pure.ts:95](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Lights/rectAreaLight.pure.ts#L95)
...
The width of the area light.

##### height

`number`

The height of the area light.
...
[`AreaLight`](AreaLight.md).[`constructor`](AreaLight.md#constructor)
...
[`AreaLight`](AreaLight.md).[`animations`](AreaLight.md#animations)
...
[`AreaLight`](AreaLight.md).[`diffuse`](AreaLight.md#diffuse)
...
[`AreaLight`](AreaLight.md).[`falloffType`](AreaLight.md#fallofftype)
...
[`AreaLight`](AreaLight.md).[`id`](AreaLight.md#id)
...
[`AreaLight`](AreaLight.md).[`inspectableCustomProperties`](AreaLight.md#inspectablecustomproperties)
...
[`AreaLight`](AreaLight.md).[`intensity`](AreaLight.md#intensity)
...
[`AreaLight`](AreaLight.md).[`metadata`](AreaLight.md#metadata)
...
[`AreaLight`](AreaLight.md).[`name`](AreaLight.md#name)
...
[`AreaLight`](AreaLight.md).[`onAccessibilityTagChangedObservable`](AreaLight.md#onaccessibilitytagchangedobservable)
...
[`AreaLight`](AreaLight.md).[`onDisposeObservable`](AreaLight.md#ondisposeobservable)
...
[`AreaLight`](AreaLight.md).[`onReady`](AreaLight.md#onready)
...
Defined in: [babylonjs-source/packages/dev/core/src/Lights/areaLight.pure.ts:65](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Lights/areaLight.pure.ts#L65)

Area Light position.

#### Inherited from

[`AreaLight`](AreaLight.md).[`position`](AreaLight.md#position)
...
[`AreaLight`](AreaLight.md).[`renderPriority`](AreaLight.md#renderpriority)
...
[`AreaLight`](AreaLight.md).[`reservedDataStore`](AreaLight.md#reserveddatastore)
...
[`AreaLight`](AreaLight.md).[`specular`](AreaLight.md#specular)
...
[`AreaLight`](AreaLight.md).[`state`](AreaLight.md#state)
...
[`AreaLight`](AreaLight.md).[`uniqueId`](AreaLight.md#uniqueid)
...
[`AreaLight`](AreaLight.md).[`FALLOFF_DEFAULT`](AreaLight.md#falloff_default)
...
[`AreaLight`](AreaLight.md).[`FALLOFF_GLTF`](AreaLight.md#falloff_gltf)
...
[`AreaLight`](AreaLight.md).[`FALLOFF_PHYSICAL`](AreaLight.md#falloff_physical)
...
[`AreaLight`](AreaLight.md).[`FALLOFF_STANDARD`](AreaLight.md#falloff_standard)
...
[`AreaLight`](AreaLight.md).[`INTENSITYMODE_AUTOMATIC`](AreaLight.md#intensitymode_automatic)
...
[`AreaLight`](AreaLight.md).[`INTENSITYMODE_ILLUMINANCE`](AreaLight.md#intensitymode_illuminance)
...
[`AreaLight`](AreaLight.md).[`INTENSITYMODE_LUMINANCE`](AreaLight.md#intensitymode_luminance)
...
[`AreaLight`](AreaLight.md).[`INTENSITYMODE_LUMINOUSINTENSITY`](AreaLight.md#intensitymode_luminousintensity)
...
[`AreaLight`](AreaLight.md).[`INTENSITYMODE_LUMINOUSPOWER`](AreaLight.md#intensitymode_luminouspower)
...
[`AreaLight`](AreaLight.md).[`LIGHTMAP_DEFAULT`](AreaLight.md#lightmap_default)
...
[`AreaLight`](AreaLight.md).[`LIGHTMAP_SHADOWSONLY`](AreaLight.md#lightmap_shadowsonly)
...
[`AreaLight`](AreaLight.md).[`LIGHTMAP_SPECULAR`](AreaLight.md#lightmap_specular)
...
[`AreaLight`](AreaLight.md).[`LIGHTTYPEID_DIRECTIONALLIGHT`](AreaLight.md#lighttypeid_directionallight)
...
[`AreaLight`](AreaLight.md).[`LIGHTTYPEID_HEMISPHERICLIGHT`](AreaLight.md#lighttypeid_hemisphericlight)
...
[`AreaLight`](AreaLight.md).[`LIGHTTYPEID_POINTLIGHT`](AreaLight.md#lighttypeid_pointlight)
...
[`AreaLight`](AreaLight.md).[`LIGHTTYPEID_RECT_AREALIGHT`](AreaLight.md#lighttypeid_rect_arealight)
...
[`AreaLight`](AreaLight.md).[`LIGHTTYPEID_SPOTLIGHT`](AreaLight.md#lighttypeid_spotlight)
...
[`AreaLight`](AreaLight.md).[`accessibilityTag`](AreaLight.md#accessibilitytag)
...
[`AreaLight`](AreaLight.md).[`animationPropertiesOverride`](AreaLight.md#animationpropertiesoverride)
...
[`AreaLight`](AreaLight.md).[`behaviors`](AreaLight.md#behaviors)
...
[`AreaLight`](AreaLight.md).[`doNotSerialize`](AreaLight.md#donotserialize)
...
> **get** **emissionTexture**(): [`Nullable`](../type-aliases/Nullable.md)\<[`BaseTexture`](BaseTexture.md)\>

Defined in: [babylonjs-source/packages/dev/core/src/Lights/rectAreaLight.pure.ts:31](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Lights/rectAreaLight.pure.ts#L31)
...
> **set** **emissionTexture**(`value`): `void`

Defined in: [babylonjs-source/packages/dev/core/src/Lights/rectAreaLight.pure.ts:38](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Lights/rectAreaLight.pure.ts#L38)
...
[`AreaLight`](AreaLight.md).[`excludedMeshes`](AreaLight.md#excludedmeshes)
...
[`AreaLight`](AreaLight.md).[`excludeWithLayerMask`](AreaLight.md#excludewithlayermask)
...
Defined in: [babylonjs-source/packages/dev/core/src/Lights/rectAreaLight.pure.ts:75](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Lights/rectAreaLight.pure.ts#L75)
...
Defined in: [babylonjs-source/packages/dev/core/src/Lights/rectAreaLight.pure.ts:81](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Lights/rectAreaLight.pure.ts#L81)
...
[`AreaLight`](AreaLight.md).[`includedOnlyMeshes`](AreaLight.md#includedonlymeshes)
...
[`AreaLight`](AreaLight.md).[`includeOnlyWithLayerMask`](AreaLight.md#includeonlywithlayermask)
...
[`AreaLight`](AreaLight.md).[`inheritVisibility`](AreaLight.md#inheritvisibility)
...
[`AreaLight`](AreaLight.md).[`intensityMode`](AreaLight.md#intensitymode)
...
[`AreaLight`](AreaLight.md).[`isVisible`](AreaLight.md#isvisible)
...
[`AreaLight`](AreaLight.md).[`lightmapMode`](AreaLight.md#lightmapmode)
...
[`AreaLight`](AreaLight.md).[`onClonedObservable`](AreaLight.md#onclonedobservable)
...
[`AreaLight`](AreaLight.md).[`onDispose`](AreaLight.md#ondispose)
...
[`AreaLight`](AreaLight.md).[`onEnabledStateChangedObservable`](AreaLight.md#onenabledstatechangedobservable)
...
[`AreaLight`](AreaLight.md).[`parent`](AreaLight.md#parent)
...
[`AreaLight`](AreaLight.md).[`radius`](AreaLight.md#radius)
...
[`AreaLight`](AreaLight.md).[`range`](AreaLight.md#range)
...
[`AreaLight`](AreaLight.md).[`shadowEnabled`](AreaLight.md#shadowenabled)
...
Defined in: [babylonjs-source/packages/dev/core/src/Lights/rectAreaLight.pure.ts:61](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Lights/rectAreaLight.pure.ts#L61)
...
Defined in: [babylonjs-source/packages/dev/core/src/Lights/rectAreaLight.pure.ts:67](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Lights/rectAreaLight.pure.ts#L67)
...
[`AreaLight`](AreaLight.md).[`worldMatrixFromCache`](AreaLight.md#worldmatrixfromcache)
...
[`AreaLight`](AreaLight.md).[`_bindLight`](AreaLight.md#_bindlight)
...
[`AreaLight`](AreaLight.md).[`addBehavior`](AreaLight.md#addbehavior)
...
[`AreaLight`](AreaLight.md).[`areLightTexturesReady`](AreaLight.md#arelighttexturesready)
...
[`AreaLight`](AreaLight.md).[`beginAnimation`](AreaLight.md#beginanimation)
...
[`AreaLight`](AreaLight.md).[`canAffectMesh`](AreaLight.md#canaffectmesh)
...
[`AreaLight`](AreaLight.md).[`clone`](AreaLight.md#clone)
...
[`AreaLight`](AreaLight.md).[`computeWorldMatrix`](AreaLight.md#computeworldmatrix)
...
[`AreaLight`](AreaLight.md).[`createAnimationRange`](AreaLight.md#createanimationrange)
...
[`AreaLight`](AreaLight.md).[`deleteAnimationRange`](AreaLight.md#deleteanimationrange)
...
[`AreaLight`](AreaLight.md).[`dispose`](AreaLight.md#dispose)
...
[`AreaLight`](AreaLight.md).[`getAbsolutePosition`](AreaLight.md#getabsoluteposition)
...
[`AreaLight`](AreaLight.md).[`getAnimationByName`](AreaLight.md#getanimationbyname)
...
[`AreaLight`](AreaLight.md).[`getAnimationRange`](AreaLight.md#getanimationrange)
...
[`AreaLight`](AreaLight.md).[`getAnimationRanges`](AreaLight.md#getanimationranges)
...
[`AreaLight`](AreaLight.md).[`getBehaviorByName`](AreaLight.md#getbehaviorbyname)
...
[`AreaLight`](AreaLight.md).[`getChildMeshes`](AreaLight.md#getchildmeshes)
...
[`AreaLight`](AreaLight.md).[`getChildren`](AreaLight.md#getchildren)
...
Defined in: [babylonjs-source/packages/dev/core/src/Lights/rectAreaLight.pure.ts:108](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Lights/rectAreaLight.pure.ts#L108)
...
[`AreaLight`](AreaLight.md).[`getClassName`](AreaLight.md#getclassname)
...
[`AreaLight`](AreaLight.md).[`getDescendants`](AreaLight.md#getdescendants)
...
[`AreaLight`](AreaLight.md).[`getEngine`](AreaLight.md#getengine)
...
[`AreaLight`](AreaLight.md).[`getHierarchyBoundingVectors`](AreaLight.md#gethierarchyboundingvectors)
...
[`AreaLight`](AreaLight.md).[`getProjectionMatrix`](AreaLight.md#getprojectionmatrix)
...
[`AreaLight`](AreaLight.md).[`getScaledIntensity`](AreaLight.md#getscaledintensity)
...
[`AreaLight`](AreaLight.md).[`getScene`](AreaLight.md#getscene)
...
[`AreaLight`](AreaLight.md).[`getShadowGenerator`](AreaLight.md#getshadowgenerator)
...
[`AreaLight`](AreaLight.md).[`getShadowGenerators`](AreaLight.md#getshadowgenerators)
...
Defined in: [babylonjs-source/packages/dev/core/src/Lights/rectAreaLight.pure.ts:117](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Lights/rectAreaLight.pure.ts#L117)
...
[`AreaLight`](AreaLight.md).[`getTypeID`](AreaLight.md#gettypeid)
...
[`AreaLight`](AreaLight.md).[`getViewMatrix`](AreaLight.md#getviewmatrix)
...
[`AreaLight`](AreaLight.md).[`getWorldMatrix`](AreaLight.md#getworldmatrix)
...
[`AreaLight`](AreaLight.md).[`isDescendantOf`](AreaLight.md#isdescendantof)
...
[`AreaLight`](AreaLight.md).[`isDisposed`](AreaLight.md#isdisposed)
...
[`AreaLight`](AreaLight.md).[`isEnabled`](AreaLight.md#isenabled)
...
[`AreaLight`](AreaLight.md).[`isReady`](AreaLight.md#isready)
...
[`AreaLight`](AreaLight.md).[`markAsDirty`](AreaLight.md#markasdirty)
...
Defined in: [babylonjs-source/packages/dev/core/src/Lights/rectAreaLight.pure.ts:213](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Lights/rectAreaLight.pure.ts#L213)
...
[`AreaLight`](AreaLight.md).[`prepareLightSpecificDefines`](AreaLight.md#preparelightspecificdefines)
...
[`AreaLight`](AreaLight.md).[`removeBehavior`](AreaLight.md#removebehavior)
...
[`AreaLight`](AreaLight.md).[`serialize`](AreaLight.md#serialize)
...
[`AreaLight`](AreaLight.md).[`serializeAnimationRanges`](AreaLight.md#serializeanimationranges)
...
[`AreaLight`](AreaLight.md).[`setEnabled`](AreaLight.md#setenabled)
...
[`AreaLight`](AreaLight.md).[`toString`](AreaLight.md#tostring)
...
Defined in: [babylonjs-source/packages/dev/core/src/Lights/rectAreaLight.pure.ts:182](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Lights/rectAreaLight.pure.ts#L182)
...
[`AreaLight`](AreaLight.md).[`transferTexturesToEffect`](AreaLight.md#transfertexturestoeffect)

***

### transferToEffect()

> **transferToEffect**(`effect`, `lightIndex`): `RectAreaLight`

Defined in: [babylonjs-source/packages/dev/core/src/Lights/rectAreaLight.pure.ts:153](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Lights/rectAreaLight.pure.ts#L153)
...
[`AreaLight`](AreaLight.md).[`transferToEffect`](AreaLight.md#transfertoeffect)

***

### transferToNodeMaterialEffect()

> **transferToNodeMaterialEffect**(`effect`, `lightDataUniformName`): `RectAreaLight`

Defined in: [babylonjs-source/packages/dev/core/src/Lights/rectAreaLight.pure.ts:192](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Lights/rectAreaLight.pure.ts#L192)
...
[`AreaLight`](AreaLight.md).[`transferToNodeMaterialEffect`](AreaLight.md#transfertonodematerialeffect)
...
[`AreaLight`](AreaLight.md).[`AddNodeConstructor`](AreaLight.md#addnodeconstructor)
...
[`AreaLight`](AreaLight.md).[`Construct`](AreaLight.md#construct)
...
[`AreaLight`](AreaLight.md).[`GetConstructorFromName`](AreaLight.md#getconstructorfromname)
...
[`AreaLight`](AreaLight.md).[`Parse`](AreaLight.md#parse)
...
[`AreaLight`](AreaLight.md).[`ParseAnimationRanges`](AreaLight.md#parseanimationranges)
