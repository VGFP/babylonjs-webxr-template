...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphOneBitsCounterBlock

# Class: FlowGraphOneBitsCounterBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:1292](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L1292)

Count one bits operation

## Extends

- `FlowGraphUnaryOperationBlock`\<[`FlowGraphInteger`](FlowGraphInteger.md), [`FlowGraphInteger`](FlowGraphInteger.md)\>

## Constructors

### Constructor

> **new FlowGraphOneBitsCounterBlock**(`config?`): `FlowGraphOneBitsCounterBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:1293](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L1293)
...
`FlowGraphUnaryOperationBlock<FlowGraphInteger, FlowGraphInteger>.constructor`

## Properties

### a

> **a**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<[`FlowGraphInteger`](FlowGraphInteger.md)\>
