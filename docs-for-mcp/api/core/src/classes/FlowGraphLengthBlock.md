...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphLengthBlock

# Class: FlowGraphLengthBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:34](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L34)

Vector length block.

## Extends

- `FlowGraphUnaryOperationBlock`\<`FlowGraphVector`, `number`\>

## Constructors

### Constructor

> **new FlowGraphLengthBlock**(`config?`): `FlowGraphLengthBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:35](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L35)
...
`FlowGraphUnaryOperationBlock<FlowGraphVector, number>.constructor`
