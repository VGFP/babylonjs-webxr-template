...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / AbstractAudioOutNode

# Abstract Class: AbstractAudioOutNode

Defined in: [babylonjs-source/packages/dev/core/src/AudioV2/abstractAudio/abstractAudioOutNode.ts:16](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/AudioV2/abstractAudio/abstractAudioOutNode.ts#L16)
...
[`AbstractNamedAudioNode`](AbstractNamedAudioNode.md).[`engine`](AbstractNamedAudioNode.md#engine)
...
[`AbstractNamedAudioNode`](AbstractNamedAudioNode.md).[`onNameChangedObservable`](AbstractNamedAudioNode.md#onnamechangedobservable)
...
[`AbstractNamedAudioNode`](AbstractNamedAudioNode.md).[`name`](AbstractNamedAudioNode.md#name)
...
[`AbstractNamedAudioNode`](AbstractNamedAudioNode.md).[`dispose`](AbstractNamedAudioNode.md#dispose)
...
[`AbstractNamedAudioNode`](AbstractNamedAudioNode.md).[`getClassName`](AbstractNamedAudioNode.md#getclassname)
