...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / AnaglyphPostProcess

# Class: AnaglyphPostProcess

Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/anaglyphPostProcess.pure.ts:14](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/PostProcesses/anaglyphPostProcess.pure.ts#L14)
...
> **new AnaglyphPostProcess**(`name`, `options`, `rigCameras`, `samplingMode?`, `engine?`, `reusable?`): `AnaglyphPostProcess`

Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/anaglyphPostProcess.pure.ts:34](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/PostProcesses/anaglyphPostProcess.pure.ts#L34)
...
[`ScreenSpaceReflectionPostProcess`](ScreenSpaceReflectionPostProcess.md).[`adaptScaleToCurrentViewport`](ScreenSpaceReflectionPostProcess.md#adaptscaletocurrentviewport)
...
[`ScreenSpaceReflectionPostProcess`](ScreenSpaceReflectionPostProcess.md).[`alwaysForcePOT`](ScreenSpaceReflectionPostProcess.md#alwaysforcepot)
...
[`ScreenSpaceReflectionPostProcess`](ScreenSpaceReflectionPostProcess.md).[`autoClear`](ScreenSpaceReflectionPostProcess.md#autoclear)
...
[`ScreenSpaceReflectionPostProcess`](ScreenSpaceReflectionPostProcess.md).[`doNotSerialize`](ScreenSpaceReflectionPostProcess.md#donotserialize)
...
[`ScreenSpaceReflectionPostProcess`](ScreenSpaceReflectionPostProcess.md).[`enablePixelPerfectMode`](ScreenSpaceReflectionPostProcess.md#enablepixelperfectmode)
...
[`ScreenSpaceReflectionPostProcess`](ScreenSpaceReflectionPostProcess.md).[`externalTextureSamplerBinding`](ScreenSpaceReflectionPostProcess.md#externaltexturesamplerbinding)
...
[`ScreenSpaceReflectionPostProcess`](ScreenSpaceReflectionPostProcess.md).[`forceAutoClearInAlphaMode`](ScreenSpaceReflectionPostProcess.md#forceautoclearinalphamode)
...
[`ScreenSpaceReflectionPostProcess`](ScreenSpaceReflectionPostProcess.md).[`forceFullscreenViewport`](ScreenSpaceReflectionPostProcess.md#forcefullscreenviewport)
...
[`ScreenSpaceReflectionPostProcess`](ScreenSpaceReflectionPostProcess.md).[`height`](ScreenSpaceReflectionPostProcess.md#height)
...
[`ScreenSpaceReflectionPostProcess`](ScreenSpaceReflectionPostProcess.md).[`onActivateObservable`](ScreenSpaceReflectionPostProcess.md#onactivateobservable)
...
[`ScreenSpaceReflectionPostProcess`](ScreenSpaceReflectionPostProcess.md).[`onAfterRenderObservable`](ScreenSpaceReflectionPostProcess.md#onafterrenderobservable)
...
[`ScreenSpaceReflectionPostProcess`](ScreenSpaceReflectionPostProcess.md).[`onApplyObservable`](ScreenSpaceReflectionPostProcess.md#onapplyobservable)
...
[`ScreenSpaceReflectionPostProcess`](ScreenSpaceReflectionPostProcess.md).[`onBeforeRenderObservable`](ScreenSpaceReflectionPostProcess.md#onbeforerenderobservable)
...
[`ScreenSpaceReflectionPostProcess`](ScreenSpaceReflectionPostProcess.md).[`onDisposeObservable`](ScreenSpaceReflectionPostProcess.md#ondisposeobservable)
...
[`ScreenSpaceReflectionPostProcess`](ScreenSpaceReflectionPostProcess.md).[`onSizeChangedObservable`](ScreenSpaceReflectionPostProcess.md#onsizechangedobservable)
...
[`ScreenSpaceReflectionPostProcess`](ScreenSpaceReflectionPostProcess.md).[`scaleMode`](ScreenSpaceReflectionPostProcess.md#scalemode)
...
[`ScreenSpaceReflectionPostProcess`](ScreenSpaceReflectionPostProcess.md).[`width`](ScreenSpaceReflectionPostProcess.md#width)
...
Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/anaglyphPostProcess.pure.ts:21](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/PostProcesses/anaglyphPostProcess.pure.ts#L21)
