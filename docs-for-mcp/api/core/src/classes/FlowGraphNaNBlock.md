...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphNaNBlock

# Class: FlowGraphNaNBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:350](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L350)

NaN constant.

## Extends

- `FlowGraphConstantOperationBlock`\<`number`\>

## Constructors

### Constructor

> **new FlowGraphNaNBlock**(`config?`): `FlowGraphNaNBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:351](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L351)
...
`FlowGraphConstantOperationBlock<number>.constructor`
