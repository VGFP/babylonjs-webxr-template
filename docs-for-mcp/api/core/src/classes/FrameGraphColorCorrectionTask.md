...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FrameGraphColorCorrectionTask

# Class: FrameGraphColorCorrectionTask

Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/colorCorrectionTask.ts:8](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/colorCorrectionTask.ts#L8)
...
> **new FrameGraphColorCorrectionTask**(`name`, `frameGraph`, `colorTableUrl`, `thinPostProcess?`): `FrameGraphColorCorrectionTask`

Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/colorCorrectionTask.ts:18](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/colorCorrectionTask.ts#L18)
...
The URL of the color table to use for the color correction effect.

##### thinPostProcess?

[`ThinColorCorrectionPostProcess`](ThinColorCorrectionPostProcess.md)

The thin post process to use for the color correction effect. If not provided, a new one will be created.
...
> `readonly` **postProcess**: [`ThinColorCorrectionPostProcess`](ThinColorCorrectionPostProcess.md)

Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/colorCorrectionTask.ts:9](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/colorCorrectionTask.ts#L9)
...
Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/colorCorrectionTask.ts:22](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FrameGraph/Tasks/PostProcesses/colorCorrectionTask.ts#L22)
