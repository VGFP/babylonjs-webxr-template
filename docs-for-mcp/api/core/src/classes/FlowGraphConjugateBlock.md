...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphConjugateBlock

# Class: FlowGraphConjugateBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:206](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L206)

Conjugate the quaternion.

## Extends

- `FlowGraphUnaryOperationBlock`\<[`Quaternion`](Quaternion.md), [`Quaternion`](Quaternion.md)\>

## Constructors

### Constructor

> **new FlowGraphConjugateBlock**(`config?`): `FlowGraphConjugateBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:207](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L207)
...
`FlowGraphUnaryOperationBlock<Quaternion, Quaternion>.constructor`
