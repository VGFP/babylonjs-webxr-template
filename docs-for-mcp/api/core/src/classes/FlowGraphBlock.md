...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphBlock

# Class: FlowGraphBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/flowGraphBlock.ts:56](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/flowGraphBlock.ts#L56)
...
- [`FlowGraphInterpolationBlock`](FlowGraphInterpolationBlock.md)
- [`FlowGraphEasingBlock`](FlowGraphEasingBlock.md)
- [`FlowGraphBezierCurveEasingBlock`](FlowGraphBezierCurveEasingBlock.md)
- [`FlowGraphConditionalDataBlock`](FlowGraphConditionalDataBlock.md)
- [`FlowGraphGetVariableBlock`](FlowGraphGetVariableBlock.md)
- [`FlowGraphTransformCoordinatesSystemBlock`](FlowGraphTransformCoordinatesSystemBlock.md)
- [`FlowGraphConstantBlock`](FlowGraphConstantBlock.md)
- [`FlowGraphGetAssetBlock`](FlowGraphGetAssetBlock.md)
- [`FlowGraphDataSwitchBlock`](FlowGraphDataSwitchBlock.md)
- [`FlowGraphIsKeyPressedBlock`](FlowGraphIsKeyPressedBlock.md)
- [`FlowGraphMatrixDecomposeBlock`](FlowGraphMatrixDecomposeBlock.md)
- [`FlowGraphMatrixComposeBlock`](FlowGraphMatrixComposeBlock.md)
- [`FlowGraphAxisAngleFromQuaternionBlock`](FlowGraphAxisAngleFromQuaternionBlock.md)
- [`FlowGraphContextBlock`](FlowGraphContextBlock.md)
- [`FlowGraphArrayIndexBlock`](FlowGraphArrayIndexBlock.md)
- [`FlowGraphCodeExecutionBlock`](FlowGraphCodeExecutionBlock.md)
- [`FlowGraphIndexOfBlock`](FlowGraphIndexOfBlock.md)
- [`FlowGraphFunctionReferenceBlock`](FlowGraphFunctionReferenceBlock.md)
- [`FlowGraphGetPhysicsMassPropertiesBlock`](FlowGraphGetPhysicsMassPropertiesBlock.md)
- [`FlowGraphGLTFDataProvider`](../../../loaders/src/namespaces/GLTF2/classes/FlowGraphGLTFDataProvider.md)
...
Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/flowGraphBlock.ts:198](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/flowGraphBlock.ts#L198)
