...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphFloatToBoolean

# Class: FlowGraphFloatToBoolean

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Transformers/flowGraphTypeToTypeBlocks.pure.ts:31](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Transformers/flowGraphTypeToTypeBlocks.pure.ts#L31)

A block that converts a float to a boolean.

## Extends

- `FlowGraphUnaryOperationBlock`\<`number`, `boolean`\>

## Constructors

### Constructor

> **new FlowGraphFloatToBoolean**(`config?`): `FlowGraphFloatToBoolean`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Transformers/flowGraphTypeToTypeBlocks.pure.ts:32](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Transformers/flowGraphTypeToTypeBlocks.pure.ts#L32)
...
`FlowGraphUnaryOperationBlock<number, boolean>.constructor`
