...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / ArcRotateCameraMovement

# Class: ArcRotateCameraMovement

Defined in: [babylonjs-source/packages/dev/core/src/Cameras/arcRotateCameraMovement.ts:38](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Cameras/arcRotateCameraMovement.ts#L38)
...
> **new ArcRotateCameraMovement**(`scene`, `cameraPosition`, `behavior?`): `ArcRotateCameraMovement`

Defined in: [babylonjs-source/packages/dev/core/src/Cameras/arcRotateCameraMovement.ts:42](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Cameras/arcRotateCameraMovement.ts#L42)
...
[`InterpolatingBehavior`](InterpolatingBehavior.md)\<[`ArcRotateCamera`](ArcRotateCamera.md)\>

#### Returns

`ArcRotateCameraMovement`
...
> `readonly` **input**: [`InputMapper`](InputMapper.md)\<[`ArcRotateHandlers`](../type-aliases/ArcRotateHandlers.md)\>

Defined in: [babylonjs-source/packages/dev/core/src/Cameras/arcRotateCameraMovement.ts:40](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Cameras/arcRotateCameraMovement.ts#L40)
