...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphAngleBetweenBlock

# Class: FlowGraphAngleBetweenBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:215](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L215)

Get the angle between two quaternions.

## Extends

- `FlowGraphBinaryOperationBlock`\<[`Quaternion`](Quaternion.md), [`Quaternion`](Quaternion.md), `number`\>

## Constructors

### Constructor

> **new FlowGraphAngleBetweenBlock**(`config?`): `FlowGraphAngleBetweenBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:216](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L216)
...
`FlowGraphBinaryOperationBlock<Quaternion, Quaternion, number>.constructor`
