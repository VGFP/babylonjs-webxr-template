...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphQuaternionFromDirectionsBlock

# Class: FlowGraphQuaternionFromDirectionsBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:301](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L301)

Get the quaternion from two direction vectors.

## Extends

- `FlowGraphBinaryOperationBlock`\<[`Vector3`](Vector3.md), [`Vector3`](Vector3.md), [`Quaternion`](Quaternion.md)\>

## Constructors

### Constructor

> **new FlowGraphQuaternionFromDirectionsBlock**(`config?`): `FlowGraphQuaternionFromDirectionsBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:302](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L302)
...
`FlowGraphBinaryOperationBlock<Vector3, Vector3, Quaternion>.constructor`
...
> **b**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<[`Vector3`](Vector3.md)\>
