...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphRandomBlock

# Class: FlowGraphRandomBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:274](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L274)
...
- `FlowGraphConstantOperationBlock`\<`FlowGraphMathOperationType`\>

## Constructors

### Constructor

> **new FlowGraphRandomBlock**(`config?`): `FlowGraphRandomBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:290](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L290)
...
`FlowGraphConstantOperationBlock<FlowGraphMathOperationType>.constructor`
...
`FlowGraphConstantOperationBlock.config`
...
`FlowGraphConstantOperationBlock.dataInputs`
...
`FlowGraphConstantOperationBlock.dataOutputs`
...
`FlowGraphConstantOperationBlock.isValid`

***

### max

> `readonly` **max**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<`number`\>

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:282](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L282)
...
`FlowGraphConstantOperationBlock.metadata`

***

### min

> `readonly` **min**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<`number`\>

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:278](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L278)
...
`FlowGraphConstantOperationBlock.name`
...
`FlowGraphConstantOperationBlock.uniqueId`

***

### value

> `readonly` **value**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<`FlowGraphMathOperationType`\>
...
`FlowGraphConstantOperationBlock.value`

## Methods

### \_doOperation()

> **\_doOperation**(`context`): `FlowGraphMathOperationType`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphConstantOperationBlock.ts:25](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphConstantOperationBlock.ts#L25)
...
`FlowGraphConstantOperationBlock._doOperation`
...
`FlowGraphConstantOperationBlock.deserialize`
...
Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphConstantOperationBlock.ts:33](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphConstantOperationBlock.ts#L33)
...
`FlowGraphConstantOperationBlock.getClassName`
...
`FlowGraphConstantOperationBlock.getDataInput`
...
`FlowGraphConstantOperationBlock.getDataOutput`
...
`FlowGraphConstantOperationBlock.registerDataInput`
...
`FlowGraphConstantOperationBlock.registerDataOutput`
...
`FlowGraphConstantOperationBlock.serialize`
