...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / Material

# Class: Material

Defined in: [babylonjs-source/packages/dev/core/src/Materials/material.ts:85](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Materials/material.ts#L85)
...
> **new Material**(`name`, `scene?`, `doNotAdd?`, `forceGLSL?`): `Material`

Defined in: [babylonjs-source/packages/dev/core/src/Materials/material.ts:1072](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Materials/material.ts#L1072)
...
> **onDisposeObservable**: [`Observable`](Observable.md)\<`Material`\>
...
> `static` **OnEventObservable**: [`Observable`](Observable.md)\<`Material`\>
...
> **get** **onUnBindObservable**(): [`Observable`](Observable.md)\<`Material`\>
...
[`Observable`](Observable.md)\<`Material`\>
...
> **clone**(`name`): [`Nullable`](../type-aliases/Nullable.md)\<`Material`\>
...
[`Nullable`](../type-aliases/Nullable.md)\<`Material`\>
...
> **dispose**(`_forceDisposeEffect?`, `forceDisposeTextures?`, `notBoundToMesh?`): `void`

Defined in: [babylonjs-source/packages/dev/core/src/Materials/material.ts:2007](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Materials/material.ts#L2007)
...
kept for backward compat. We reference count the effect now.
...
Defined in: [babylonjs-source/packages/dev/core/src/Materials/material.ts:1144](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Materials/material.ts#L1144)
...
Defined in: [babylonjs-source/packages/dev/core/src/Materials/material.ts:1210](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Materials/material.ts#L1210)
...
> `static` **Parse**(`parsedMaterial`, `scene`, `rootUrl`): [`Nullable`](../type-aliases/Nullable.md)\<`Material`\>
