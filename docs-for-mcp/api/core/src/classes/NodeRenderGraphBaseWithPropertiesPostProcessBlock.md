...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / NodeRenderGraphBaseWithPropertiesPostProcessBlock

# Class: NodeRenderGraphBaseWithPropertiesPostProcessBlock

Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Node/Blocks/PostProcesses/baseWithPropertiesPostProcessBlock.ts:8](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FrameGraph/Node/Blocks/PostProcesses/baseWithPropertiesPostProcessBlock.ts#L8)
...
- [`NodeRenderGraphAnaglyphPostProcessBlock`](NodeRenderGraphAnaglyphPostProcessBlock.md)
- [`NodeRenderGraphBlackAndWhitePostProcessBlock`](NodeRenderGraphBlackAndWhitePostProcessBlock.md)
- [`NodeRenderGraphBlurPostProcessBlock`](NodeRenderGraphBlurPostProcessBlock.md)
- [`NodeRenderGraphChromaticAberrationPostProcessBlock`](NodeRenderGraphChromaticAberrationPostProcessBlock.md)
- [`NodeRenderGraphCircleOfConfusionPostProcessBlock`](NodeRenderGraphCircleOfConfusionPostProcessBlock.md)
- [`NodeRenderGraphColorCorrectionPostProcessBlock`](NodeRenderGraphColorCorrectionPostProcessBlock.md)
- [`NodeRenderGraphConvolutionPostProcessBlock`](NodeRenderGraphConvolutionPostProcessBlock.md)
- [`NodeRenderGraphExtractHighlightsPostProcessBlock`](NodeRenderGraphExtractHighlightsPostProcessBlock.md)
- [`NodeRenderGraphFilterPostProcessBlock`](NodeRenderGraphFilterPostProcessBlock.md)
- [`NodeRenderGraphFXAAPostProcessBlock`](NodeRenderGraphFXAAPostProcessBlock.md)
- [`NodeRenderGraphGrainPostProcessBlock`](NodeRenderGraphGrainPostProcessBlock.md)
- [`NodeRenderGraphImageProcessingPostProcessBlock`](NodeRenderGraphImageProcessingPostProcessBlock.md)
- [`NodeRenderGraphMotionBlurPostProcessBlock`](NodeRenderGraphMotionBlurPostProcessBlock.md)
- [`NodeRenderGraphPassPostProcessBlock`](NodeRenderGraphPassPostProcessBlock.md)
- [`NodeRenderGraphPassCubePostProcessBlock`](NodeRenderGraphPassCubePostProcessBlock.md)
- [`NodeRenderGraphSharpenPostProcessBlock`](NodeRenderGraphSharpenPostProcessBlock.md)
- [`NodeRenderGraphScreenSpaceCurvaturePostProcessBlock`](NodeRenderGraphScreenSpaceCurvaturePostProcessBlock.md)
- [`NodeRenderGraphTAAPostProcessBlock`](NodeRenderGraphTAAPostProcessBlock.md)
- [`NodeRenderGraphTonemapPostProcessBlock`](NodeRenderGraphTonemapPostProcessBlock.md)

## Constructors

### Constructor

> **new NodeRenderGraphBaseWithPropertiesPostProcessBlock**(`name`, `frameGraph`, `scene`): `NodeRenderGraphBaseWithPropertiesPostProcessBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Node/Blocks/PostProcesses/basePostProcessBlock.ts:28](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FrameGraph/Node/Blocks/PostProcesses/basePostProcessBlock.ts#L28)
...
Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Node/Blocks/PostProcesses/baseWithPropertiesPostProcessBlock.ts:140](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FrameGraph/Node/Blocks/PostProcesses/baseWithPropertiesPostProcessBlock.ts#L140)
...
Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Node/Blocks/PostProcesses/baseWithPropertiesPostProcessBlock.ts:112](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FrameGraph/Node/Blocks/PostProcesses/baseWithPropertiesPostProcessBlock.ts#L112)
...
> **registerInput**(`name`, `type`, `isOptional?`, `point?`): `NodeRenderGraphBaseWithPropertiesPostProcessBlock`
...
> **registerOutput**(`name`, `type`, `point?`): `NodeRenderGraphBaseWithPropertiesPostProcessBlock`
...
Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Node/Blocks/PostProcesses/baseWithPropertiesPostProcessBlock.ts:127](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FrameGraph/Node/Blocks/PostProcesses/baseWithPropertiesPostProcessBlock.ts#L127)
