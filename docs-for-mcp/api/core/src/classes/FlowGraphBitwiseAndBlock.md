...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphBitwiseAndBlock

# Class: FlowGraphBitwiseAndBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:1140](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L1140)

Bitwise AND operation

## Extends

- `FlowGraphBinaryOperationBlock`\<`FlowGraphBitwiseTypes`, `FlowGraphBitwiseTypes`, `FlowGraphBitwiseTypes`\>

## Constructors

### Constructor

> **new FlowGraphBitwiseAndBlock**(`config?`): `FlowGraphBitwiseAndBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:1141](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L1141)
...
`FlowGraphBinaryOperationBlock<FlowGraphBitwiseTypes, FlowGraphBitwiseTypes, FlowGraphBitwiseTypes>.constructor`
...
> **b**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<`FlowGraphBitwiseTypes`\>
