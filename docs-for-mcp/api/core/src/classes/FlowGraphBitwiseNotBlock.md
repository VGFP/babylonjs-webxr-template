...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphBitwiseNotBlock

# Class: FlowGraphBitwiseNotBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:1118](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L1118)

Bitwise NOT operation

## Extends

- `FlowGraphUnaryOperationBlock`\<`FlowGraphBitwiseTypes`, `FlowGraphBitwiseTypes`\>

## Constructors

### Constructor

> **new FlowGraphBitwiseNotBlock**(`config?`): `FlowGraphBitwiseNotBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:1119](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L1119)
...
`FlowGraphUnaryOperationBlock<FlowGraphBitwiseTypes, FlowGraphBitwiseTypes>.constructor`

## Properties

### a

> **a**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<`FlowGraphBitwiseTypes`\>
...
> `readonly` **value**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<`FlowGraphBitwiseTypes`\>
...
> **\_doOperation**(`context`): `FlowGraphBitwiseTypes`
