...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphExtractMatrix3DBlock

# Class: FlowGraphExtractMatrix3DBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts:426](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts#L426)

Extracts 4 floats from a Matrix2D

## Extends

- `FlowGraphMathExtractBlock`\<[`FlowGraphMatrix3D`](FlowGraphMatrix3D.md)\>

## Constructors

### Constructor

> **new FlowGraphExtractMatrix3DBlock**(`config?`): `FlowGraphExtractMatrix3DBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts:427](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts#L427)
...
`FlowGraphMathExtractBlock<FlowGraphMatrix3D>.constructor`
...
Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts:441](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts#L441)
