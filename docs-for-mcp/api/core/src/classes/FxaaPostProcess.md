...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FxaaPostProcess

# Class: FxaaPostProcess

Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/fxaaPostProcess.pure.ts:20](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/PostProcesses/fxaaPostProcess.pure.ts#L20)

Fxaa post process

## See

https://doc.babylonjs.com/features/featuresDeepDive/postProcesses/usePostProcesses#fxaa
...
> **new FxaaPostProcess**(`name`, `options`, `camera?`, `samplingMode?`, `engine?`, `reusable?`, `textureType?`): `FxaaPostProcess`

Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/fxaaPostProcess.pure.ts:31](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/PostProcesses/fxaaPostProcess.pure.ts#L31)
...
Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/fxaaPostProcess.pure.ts:25](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/PostProcesses/fxaaPostProcess.pure.ts#L25)
