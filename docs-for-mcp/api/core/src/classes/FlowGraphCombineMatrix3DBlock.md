...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphCombineMatrix3DBlock

# Class: FlowGraphCombineMatrix3DBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts:252](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts#L252)

Combines 9 floats into a new Matrix3D

## Extends

- `FlowGraphMathCombineBlock`\<[`FlowGraphMatrix3D`](FlowGraphMatrix3D.md)\>

## Constructors

### Constructor

> **new FlowGraphCombineMatrix3DBlock**(`config?`): `FlowGraphCombineMatrix3DBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts:253](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts#L253)
...
`FlowGraphMathCombineBlock<FlowGraphMatrix3D>.constructor`
...
`FlowGraphMathCombineBlock.config`
...
`FlowGraphMathCombineBlock.dataInputs`
...
`FlowGraphMathCombineBlock.dataOutputs`
...
`FlowGraphMathCombineBlock.isValid`
...
`FlowGraphMathCombineBlock.metadata`
...
`FlowGraphMathCombineBlock.name`
...
`FlowGraphMathCombineBlock.uniqueId`

***

### value

> `readonly` **value**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<[`FlowGraphMatrix3D`](FlowGraphMatrix3D.md)\>
...
`FlowGraphMathCombineBlock.value`
...
`FlowGraphMathCombineBlock.deserialize`
...
Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts:290](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathCombineExtractBlocks.ts#L290)
...
`FlowGraphMathCombineBlock.getClassName`
...
`FlowGraphMathCombineBlock.getDataInput`
...
`FlowGraphMathCombineBlock.getDataOutput`
...
`FlowGraphMathCombineBlock.registerDataInput`
...
`FlowGraphMathCombineBlock.registerDataOutput`
...
`FlowGraphMathCombineBlock.serialize`
