...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphGetAssetBlock

# Class: FlowGraphGetAssetBlock\<T\>

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphGetAssetBlock.ts:39](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphGetAssetBlock.ts#L39)
...
> **new FlowGraphGetAssetBlock**\<`T`\>(`config`): `FlowGraphGetAssetBlock`\<`T`\>

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphGetAssetBlock.ts:55](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphGetAssetBlock.ts#L55)

#### Parameters

##### config

[`IFlowGraphGetAssetBlockConfiguration`](../interfaces/IFlowGraphGetAssetBlockConfiguration.md)\<`T`\>

the configuration of the block

#### Returns

`FlowGraphGetAssetBlock`\<`T`\>
...
> **config**: [`IFlowGraphGetAssetBlockConfiguration`](../interfaces/IFlowGraphGetAssetBlockConfiguration.md)\<`T`\>

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphGetAssetBlock.ts:59](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphGetAssetBlock.ts#L59)
...
Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphGetAssetBlock.ts:53](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphGetAssetBlock.ts#L53)
...
> `readonly` **type**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<`T`\>

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphGetAssetBlock.ts:48](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphGetAssetBlock.ts#L48)
...
> `readonly` **value**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<[`Nullable`](../type-aliases/Nullable.md)\<[`AssetType`](../type-aliases/AssetType.md)\<`T`\>\>\>

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphGetAssetBlock.ts:43](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphGetAssetBlock.ts#L43)
...
Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphGetAssetBlock.ts:79](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphGetAssetBlock.ts#L79)
