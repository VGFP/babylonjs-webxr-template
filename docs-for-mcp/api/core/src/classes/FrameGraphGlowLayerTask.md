...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FrameGraphGlowLayerTask

# Class: FrameGraphGlowLayerTask

Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Tasks/Layers/glowLayerTask.ts:8](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FrameGraph/Tasks/Layers/glowLayerTask.ts#L8)
...
> **new FrameGraphGlowLayerTask**(`name`, `frameGraph`, `scene`, `options?`): `FrameGraphGlowLayerTask`

Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Tasks/Layers/glowLayerTask.ts:21](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FrameGraph/Tasks/Layers/glowLayerTask.ts#L21)
...
The scene to render the glow layer in.

##### options?

[`IThinGlowLayerOptions`](../interfaces/IThinGlowLayerOptions.md)

Options for the glow layer.
...
Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Tasks/Layers/glowLayerTask.ts:12](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FrameGraph/Tasks/Layers/glowLayerTask.ts#L12)
...
Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Tasks/Layers/glowLayerTask.ts:27](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FrameGraph/Tasks/Layers/glowLayerTask.ts#L27)
...
> **record**(`_skipCreationOfDisabledPasses?`, `additionalComposeBindings?`): `void`

Defined in: [babylonjs-source/packages/dev/core/src/FrameGraph/Tasks/Layers/baseLayerTask.ts:247](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FrameGraph/Tasks/Layers/baseLayerTask.ts#L247)

Records the layer task into the frame graph.

#### Parameters

##### \_skipCreationOfDisabledPasses?

`boolean`

defines whether disabled passes should be skipped

##### additionalComposeBindings?

(`context`, `effect`) => `void`

defines an optional callback used to bind extra compose resources
