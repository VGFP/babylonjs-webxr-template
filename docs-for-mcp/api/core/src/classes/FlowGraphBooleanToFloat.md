...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphBooleanToFloat

# Class: FlowGraphBooleanToFloat

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Transformers/flowGraphTypeToTypeBlocks.pure.ts:13](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Transformers/flowGraphTypeToTypeBlocks.pure.ts#L13)

A block that converts a boolean to a float.

## Extends

- `FlowGraphUnaryOperationBlock`\<`boolean`, `number`\>

## Constructors

### Constructor

> **new FlowGraphBooleanToFloat**(`config?`): `FlowGraphBooleanToFloat`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Transformers/flowGraphTypeToTypeBlocks.pure.ts:14](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Transformers/flowGraphTypeToTypeBlocks.pure.ts#L14)
...
`FlowGraphUnaryOperationBlock<boolean, number>.constructor`
