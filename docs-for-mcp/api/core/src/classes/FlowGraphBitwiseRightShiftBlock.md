...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphBitwiseRightShiftBlock

# Class: FlowGraphBitwiseRightShiftBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:1234](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L1234)

Bitwise right shift operation

## Extends

- `FlowGraphBinaryOperationBlock`\<[`FlowGraphInteger`](FlowGraphInteger.md), [`FlowGraphInteger`](FlowGraphInteger.md), [`FlowGraphInteger`](FlowGraphInteger.md)\>

## Constructors

### Constructor

> **new FlowGraphBitwiseRightShiftBlock**(`config?`): `FlowGraphBitwiseRightShiftBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:1235](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L1235)
...
`FlowGraphBinaryOperationBlock<FlowGraphInteger, FlowGraphInteger, FlowGraphInteger>.constructor`
...
Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphBinaryOperationBlock.ts:14](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphBinaryOperationBlock.ts#L14)
...
> **b**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<[`FlowGraphInteger`](FlowGraphInteger.md)\>

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphBinaryOperationBlock.ts:18](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphBinaryOperationBlock.ts#L18)
...
Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphBinaryOperationBlock.ts:38](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphBinaryOperationBlock.ts#L38)
...
Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphBinaryOperationBlock.ts:48](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphBinaryOperationBlock.ts#L48)
