...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / ExtractHighlightsPostProcess

# Class: ExtractHighlightsPostProcess

Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/extractHighlightsPostProcess.pure.ts:17](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/PostProcesses/extractHighlightsPostProcess.pure.ts#L17)
...
> **new ExtractHighlightsPostProcess**(`name`, `options`, `camera?`, `samplingMode?`, `engine?`, `reusable?`, `textureType?`, `blockCompilation?`): `ExtractHighlightsPostProcess`

Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/extractHighlightsPostProcess.pure.ts:56](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/PostProcesses/extractHighlightsPostProcess.pure.ts#L56)
...
Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/extractHighlightsPostProcess.pure.ts:22](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/PostProcesses/extractHighlightsPostProcess.pure.ts#L22)
...
Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/extractHighlightsPostProcess.pure.ts:26](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/PostProcesses/extractHighlightsPostProcess.pure.ts#L26)
...
Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/extractHighlightsPostProcess.pure.ts:50](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/PostProcesses/extractHighlightsPostProcess.pure.ts#L50)
