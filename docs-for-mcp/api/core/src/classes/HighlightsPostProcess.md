...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / HighlightsPostProcess

# Class: HighlightsPostProcess

Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/highlightsPostProcess.ts:11](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/PostProcesses/highlightsPostProcess.ts#L11)
...
> **new HighlightsPostProcess**(`name`, `options`, `camera`, `samplingMode?`, `engine?`, `reusable?`, `textureType?`): `HighlightsPostProcess`

Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/highlightsPostProcess.ts:31](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/PostProcesses/highlightsPostProcess.ts#L31)
...
Type of texture for the post process (default: Engine.TEXTURETYPE_UNSIGNED_BYTE)
...
Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/highlightsPostProcess.ts:16](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/PostProcesses/highlightsPostProcess.ts#L16)
