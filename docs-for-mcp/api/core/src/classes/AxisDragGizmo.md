...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / AxisDragGizmo

# Class: AxisDragGizmo

Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/axisDragGizmo.ts:44](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Gizmos/axisDragGizmo.ts#L44)
...
> **new AxisDragGizmo**(`dragAxis`, `color?`, `gizmoLayer?`, `parent?`, `thickness?`, `hoverColor?`, `disableColor?`): `AxisDragGizmo`

Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/axisDragGizmo.ts:150](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Gizmos/axisDragGizmo.ts#L150)
...
[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`_rootMesh`](../interfaces/IAxisDragGizmo.md#_rootmesh)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/axisDragGizmo.ts:48](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Gizmos/axisDragGizmo.ts#L48)

Drag behavior responsible for the gizmos dragging interactions

#### Implementation of

[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`dragBehavior`](../interfaces/IAxisDragGizmo.md#dragbehavior)
...
[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`gizmoLayer`](../interfaces/IAxisDragGizmo.md#gizmolayer)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/axisDragGizmo.ts:58](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Gizmos/axisDragGizmo.ts#L58)
...
[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`onSnapObservable`](../interfaces/IAxisDragGizmo.md#onsnapobservable)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/axisDragGizmo.ts:53](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Gizmos/axisDragGizmo.ts#L53)

Drag distance in babylon units that the gizmo will snap to when dragged (Default: 0)

#### Implementation of

[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`snapDistance`](../interfaces/IAxisDragGizmo.md#snapdistance)
...
[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`additionalTransformNode`](../interfaces/IAxisDragGizmo.md#additionaltransformnode)
...
[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`anchorPoint`](../interfaces/IAxisDragGizmo.md#anchorpoint)
...
[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`attachedMesh`](../interfaces/IAxisDragGizmo.md#attachedmesh)
...
[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`attachedNode`](../interfaces/IAxisDragGizmo.md#attachednode)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/axisDragGizmo.ts:70](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Gizmos/axisDragGizmo.ts#L70)
...
[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`coloredMaterial`](../interfaces/IAxisDragGizmo.md#coloredmaterial)
...
[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`coordinatesMode`](../interfaces/IAxisDragGizmo.md#coordinatesmode)
...
[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`customRotationQuaternion`](../interfaces/IAxisDragGizmo.md#customrotationquaternion)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/axisDragGizmo.ts:80](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Gizmos/axisDragGizmo.ts#L80)
...
[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`disableMaterial`](../interfaces/IAxisDragGizmo.md#disablematerial)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/axisDragGizmo.ts:75](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Gizmos/axisDragGizmo.ts#L75)
...
[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`hoverMaterial`](../interfaces/IAxisDragGizmo.md#hovermaterial)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/axisDragGizmo.ts:308](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Gizmos/axisDragGizmo.ts#L308)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/axisDragGizmo.ts:295](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Gizmos/axisDragGizmo.ts#L295)
...
[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`isEnabled`](../interfaces/IAxisDragGizmo.md#isenabled)
...
[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`isHovered`](../interfaces/IAxisDragGizmo.md#ishovered)
...
[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`scaleRatio`](../interfaces/IAxisDragGizmo.md#scaleratio)
...
[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`updateGizmoPositionToMatchAttachedMesh`](../interfaces/IAxisDragGizmo.md#updategizmopositiontomatchattachedmesh)
...
[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`updateGizmoRotationToMatchAttachedMesh`](../interfaces/IAxisDragGizmo.md#updategizmorotationtomatchattachedmesh)
...
[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`updateScale`](../interfaces/IAxisDragGizmo.md#updatescale)
...
Defined in: [babylonjs-source/packages/dev/core/src/Gizmos/axisDragGizmo.ts:315](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Gizmos/axisDragGizmo.ts#L315)
...
[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`dispose`](../interfaces/IAxisDragGizmo.md#dispose)
...
[`IAxisDragGizmo`](../interfaces/IAxisDragGizmo.md).[`setCustomMesh`](../interfaces/IAxisDragGizmo.md#setcustommesh)
