...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / WebXRCamera

# Class: WebXRCamera

Defined in: [babylonjs-source/packages/dev/core/src/XR/webXRCamera.ts:15](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/XR/webXRCamera.ts#L15)
...
> **new WebXRCamera**(`name`, `scene`, `_xrSessionManager`): `WebXRCamera`

Defined in: [babylonjs-source/packages/dev/core/src/XR/webXRCamera.ts:78](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/XR/webXRCamera.ts#L78)
...
Defined in: [babylonjs-source/packages/dev/core/src/XR/webXRCamera.ts:59](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/XR/webXRCamera.ts#L59)
...
[`FreeCamera`](FreeCamera.md).[`ignoreCameraMaxZ`](FreeCamera.md#ignorecameramaxz)
...
[`FreeCamera`](FreeCamera.md).[`movement`](FreeCamera.md#movement)
...
[`FreeCamera`](FreeCamera.md).[`oblique`](FreeCamera.md#oblique)
...
[`FreeCamera`](FreeCamera.md).[`onAccessibilityTagChangedObservable`](FreeCamera.md#onaccessibilitytagchangedobservable)
...
Defined in: [babylonjs-source/packages/dev/core/src/XR/webXRCamera.ts:47](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/XR/webXRCamera.ts#L47)

Observable raised after camera teleportation

#### Deprecated

use onAfterCameraTeleport of the teleportation feature instead
...
Defined in: [babylonjs-source/packages/dev/core/src/XR/webXRCamera.ts:41](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/XR/webXRCamera.ts#L41)

Observable raised before camera teleportation

#### Deprecated

use onBeforeCameraTeleport of the teleportation feature instead
...
> **onTrackingStateChanged**: [`Observable`](Observable.md)\<[`WebXRTrackingState`](../enumerations/WebXRTrackingState.md)\>

Defined in: [babylonjs-source/packages/dev/core/src/XR/webXRCamera.ts:53](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/XR/webXRCamera.ts#L53)
...
> **onXRCameraInitializedObservable**: [`Observable`](Observable.md)\<`WebXRCamera`\>

Defined in: [babylonjs-source/packages/dev/core/src/XR/webXRCamera.ts:35](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/XR/webXRCamera.ts#L35)
...
Defined in: [babylonjs-source/packages/dev/core/src/XR/webXRCamera.ts:70](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/XR/webXRCamera.ts#L70)
...
[`FreeCamera`](FreeCamera.md).[`absoluteRotation`](FreeCamera.md#absoluterotation)
...
[`FreeCamera`](FreeCamera.md).[`accessibilityTag`](FreeCamera.md#accessibilitytag)
...
[`FreeCamera`](FreeCamera.md).[`angularSensibility`](FreeCamera.md#angularsensibility)
...
[`FreeCamera`](FreeCamera.md).[`animationPropertiesOverride`](FreeCamera.md#animationpropertiesoverride)
...
[`FreeCamera`](FreeCamera.md).[`behaviors`](FreeCamera.md#behaviors)
...
[`FreeCamera`](FreeCamera.md).[`collisionMask`](FreeCamera.md#collisionmask)
...
[`FreeCamera`](FreeCamera.md).[`doNotSerialize`](FreeCamera.md#donotserialize)
...
[`FreeCamera`](FreeCamera.md).[`globalPosition`](FreeCamera.md#globalposition)
...
[`FreeCamera`](FreeCamera.md).[`hasMoved`](FreeCamera.md#hasmoved)
...
[`FreeCamera`](FreeCamera.md).[`inheritVisibility`](FreeCamera.md#inheritvisibility)
...
[`FreeCamera`](FreeCamera.md).[`isLeftCamera`](FreeCamera.md#isleftcamera)
...
[`FreeCamera`](FreeCamera.md).[`isRightCamera`](FreeCamera.md#isrightcamera)
...
[`FreeCamera`](FreeCamera.md).[`isVisible`](FreeCamera.md#isvisible)
...
[`FreeCamera`](FreeCamera.md).[`keysDown`](FreeCamera.md#keysdown)
...
[`FreeCamera`](FreeCamera.md).[`keysDownward`](FreeCamera.md#keysdownward)
...
[`FreeCamera`](FreeCamera.md).[`keysLeft`](FreeCamera.md#keysleft)
...
[`FreeCamera`](FreeCamera.md).[`keysRight`](FreeCamera.md#keysright)
...
[`FreeCamera`](FreeCamera.md).[`keysRotateDown`](FreeCamera.md#keysrotatedown)
...
[`FreeCamera`](FreeCamera.md).[`keysRotateLeft`](FreeCamera.md#keysrotateleft)
...
[`FreeCamera`](FreeCamera.md).[`keysRotateRight`](FreeCamera.md#keysrotateright)
...
[`FreeCamera`](FreeCamera.md).[`keysRotateUp`](FreeCamera.md#keysrotateup)
...
[`FreeCamera`](FreeCamera.md).[`keysUp`](FreeCamera.md#keysup)
...
[`FreeCamera`](FreeCamera.md).[`keysUpward`](FreeCamera.md#keysupward)
...
[`FreeCamera`](FreeCamera.md).[`leftCamera`](FreeCamera.md#leftcamera)
...
[`FreeCamera`](FreeCamera.md).[`mode`](FreeCamera.md#mode)
...
[`FreeCamera`](FreeCamera.md).[`needMoveForGravity`](FreeCamera.md#needmoveforgravity)
...
[`FreeCamera`](FreeCamera.md).[`onClonedObservable`](FreeCamera.md#onclonedobservable)
...
[`FreeCamera`](FreeCamera.md).[`onDispose`](FreeCamera.md#ondispose)
...
[`FreeCamera`](FreeCamera.md).[`onEnabledStateChangedObservable`](FreeCamera.md#onenabledstatechangedobservable)
...
[`FreeCamera`](FreeCamera.md).[`orthoBottom`](FreeCamera.md#orthobottom)
...
[`FreeCamera`](FreeCamera.md).[`orthoLeft`](FreeCamera.md#ortholeft)
...
[`FreeCamera`](FreeCamera.md).[`orthoRight`](FreeCamera.md#orthoright)
...
[`FreeCamera`](FreeCamera.md).[`orthoTop`](FreeCamera.md#orthotop)
...
[`FreeCamera`](FreeCamera.md).[`parent`](FreeCamera.md#parent)
...
[`FreeCamera`](FreeCamera.md).[`position`](FreeCamera.md#position)
...
Defined in: [babylonjs-source/packages/dev/core/src/XR/webXRCamera.ts:149](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/XR/webXRCamera.ts#L149)
...
[`FreeCamera`](FreeCamera.md).[`rightCamera`](FreeCamera.md#rightcamera)
...
[`FreeCamera`](FreeCamera.md).[`rigPostProcess`](FreeCamera.md#rigpostprocess)
...
[`FreeCamera`](FreeCamera.md).[`screenArea`](FreeCamera.md#screenarea)
...
[`FreeCamera`](FreeCamera.md).[`target`](FreeCamera.md#target)
...
> **get** **trackingState**(): [`WebXRTrackingState`](../enumerations/WebXRTrackingState.md)

Defined in: [babylonjs-source/packages/dev/core/src/XR/webXRCamera.ts:132](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/XR/webXRCamera.ts#L132)
...
[`FreeCamera`](FreeCamera.md).[`upVector`](FreeCamera.md#upvector)
...
[`FreeCamera`](FreeCamera.md).[`worldMatrixFromCache`](FreeCamera.md#worldmatrixfromcache)
...
Defined in: [babylonjs-source/packages/dev/core/src/XR/webXRCamera.ts:214](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/XR/webXRCamera.ts#L214)
...
Defined in: [babylonjs-source/packages/dev/core/src/XR/webXRCamera.ts:194](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/XR/webXRCamera.ts#L194)
...
[`FreeCamera`](FreeCamera.md).[`hasStateStored`](FreeCamera.md#hasstatestored)
...
[`FreeCamera`](FreeCamera.md).[`setFocalLength`](FreeCamera.md#setfocallength)
...
Defined in: [babylonjs-source/packages/dev/core/src/XR/webXRCamera.ts:203](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/XR/webXRCamera.ts#L203)
...
the target to set the camera to look at
...
Defined in: [babylonjs-source/packages/dev/core/src/XR/webXRCamera.ts:175](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/XR/webXRCamera.ts#L175)
