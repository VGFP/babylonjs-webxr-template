...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphBooleanToInt

# Class: FlowGraphBooleanToInt

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Transformers/flowGraphTypeToTypeBlocks.pure.ts:22](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Transformers/flowGraphTypeToTypeBlocks.pure.ts#L22)

A block that converts a boolean to an integer

## Extends

- `FlowGraphUnaryOperationBlock`\<`boolean`, [`FlowGraphInteger`](FlowGraphInteger.md)\>

## Constructors

### Constructor

> **new FlowGraphBooleanToInt**(`config?`): `FlowGraphBooleanToInt`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Transformers/flowGraphTypeToTypeBlocks.pure.ts:23](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Transformers/flowGraphTypeToTypeBlocks.pure.ts#L23)
...
`FlowGraphUnaryOperationBlock<boolean, FlowGraphInteger>.constructor`

## Properties

### a

> **a**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<`boolean`\>
