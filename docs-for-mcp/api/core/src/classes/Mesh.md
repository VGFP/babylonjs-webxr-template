...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / Mesh

# Class: Mesh

Defined in: [babylonjs-source/packages/dev/core/src/Meshes/mesh.ts:262](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Meshes/mesh.ts#L262)
...
[`Nullable`](../type-aliases/Nullable.md)\<`Mesh`\>
...
> **onMeshReadyObservable**: [`Observable`](Observable.md)\<`Mesh`\>
...
> **get** **cloneMeshMap**(): [`Nullable`](../type-aliases/Nullable.md)\<\{\[`id`: `string`\]: `Mesh` \| `undefined`; \}\>
...
[`Nullable`](../type-aliases/Nullable.md)\<\{\[`id`: `string`\]: `Mesh` \| `undefined`; \}\>
...
[`AbstractMesh`](AbstractMesh.md).[`isAnInstance`](AbstractMesh.md#isaninstance)
...
> **get** **onAfterRenderObservable**(): [`Observable`](Observable.md)\<`Mesh`\>
...
> **get** **onBeforeBindObservable**(): [`Observable`](Observable.md)\<`Mesh`\>
...
> **get** **onBeforeDrawObservable**(): [`Observable`](Observable.md)\<`Mesh`\>
...
> **get** **onBeforeRenderObservable**(): [`Observable`](Observable.md)\<`Mesh`\>
...
> **get** **source**(): [`Nullable`](../type-aliases/Nullable.md)\<`Mesh`\>
...
[`AbstractMesh`](AbstractMesh.md).[`copyVerticesData`](AbstractMesh.md#copyverticesdata)
...
> **getFacetNormalToRef**(`i`, `ref`): `Mesh`
...
> **getLODLevelAtDistance**(`distance`): [`Nullable`](../type-aliases/Nullable.md)\<`Mesh`\>
...
[`AbstractMesh`](AbstractMesh.md).[`getVertexBuffer`](AbstractMesh.md#getvertexbuffer)
...
> **renderWithRenderPassId**(`renderPassId?`, `enableAlphaMode?`, `effectiveMeshReplacement?`, `subMesh?`, `checkFrustumCulling?`): `Mesh`
...
Defined in: [babylonjs-source/packages/dev/core/src/Meshes/mesh.ts:4094](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Meshes/mesh.ts#L4094)
...
> **setVerticesBuffer**(`buffer`, `disposeExistingBuffer?`, `totalVertices?`): `Mesh`
...
> `static` **CreateBox**(`_name`, `_size`, `_scene`, `_updatable?`, `_sideOrientation?`): `Mesh`
...
> `static` **CreateCapsule**(`_name`, `_options`, `_scene`): `Mesh`
...
> `static` **CreateCylinder**(`_name`, `_height`, `_diameterTop`, `_diameterBottom`, `_tessellation`, `_subdivisions`, `_scene?`, `_updatable?`, `_sideOrientation?`): `Mesh`
...
> `static` **CreateDecal**(`_name`, `_sourceMesh`, `_position`, `_normal`, `_size`, `_angle`): `Mesh`
...
> `static` **CreateDisc**(`_name`, `_radius`, `_tessellation`, `_scene`, `_updatable?`, `_sideOrientation?`): `Mesh`
...
> `static` **CreateGround**(`_name`, `_width`, `_height`, `_subdivisions`, `_scene?`, `_updatable?`): `Mesh`
...
> `static` **CreateHemisphere**(`_name`, `_segments`, `_diameter`, `_scene?`): `Mesh`
...
> `static` **CreateIcoSphere**(`_name`, `_options`, `_scene`): `Mesh`
...
> `static` **CreateLathe**(`_name`, `_shape`, `_radius`, `_tessellation`, `_scene`, `_updatable?`, `_sideOrientation?`): `Mesh`
...
> `static` **CreatePlane**(`_name`, `_size`, `_scene`, `_updatable?`, `_sideOrientation?`): `Mesh`
...
> `static` **CreatePolygon**(`_name`, `_shape`, `_scene`, `_holes?`, `_updatable?`, `_sideOrientation?`, `_earcutInjection?`): `Mesh`
...
> `static` **CreatePolyhedron**(`_name`, `_options`, `_scene`): `Mesh`
...
> `static` **CreateRibbon**(`_name`, `_pathArray`, `_closeArray`, `_closePath`, `_offset`, `_scene?`, `_updatable?`, `_sideOrientation?`, `_instance?`): `Mesh`
...
> `static` **CreateSphere**(`_name`, `_segments`, `_diameter`, `_scene?`, `_updatable?`, `_sideOrientation?`): `Mesh`
...
> `static` **CreateTiledGround**(`_name`, `_xmin`, `_zmin`, `_xmax`, `_zmax`, `_subdivisions`, `_precision`, `_scene`, `_updatable?`): `Mesh`
...
> `static` **CreateTorus**(`_name`, `_diameter`, `_thickness`, `_tessellation`, `_scene?`, `_updatable?`, `_sideOrientation?`): `Mesh`
...
> `static` **CreateTorusKnot**(`_name`, `_radius`, `_tube`, `_radialSegments`, `_tubularSegments`, `_p`, `_q`, `_scene?`, `_updatable?`, `_sideOrientation?`): `Mesh`
...
> `static` **CreateTube**(`_name`, `_path`, `_radius`, `_tessellation`, `_radiusFunction`, `_cap`, `_scene`, `_updatable?`, `_sideOrientation?`, `_instance?`): `Mesh`
...
> `static` **ExtendToGoldberg**(`_mesh`): `Mesh`
...
> `static` **ExtrudePolygon**(`_name`, `_shape`, `_depth`, `_scene`, `_holes?`, `_updatable?`, `_sideOrientation?`, `_earcutInjection?`): `Mesh`
...
> `static` **ExtrudeShape**(`_name`, `_shape`, `_path`, `_scale`, `_rotation`, `_cap`, `_scene`, `_updatable?`, `_sideOrientation?`, `_instance?`): `Mesh`
...
> `static` **ExtrudeShapeCustom**(`_name`, `_shape`, `_path`, `_scaleFunction`, `_rotationFunction`, `_ribbonCloseArray`, `_ribbonClosePath`, `_cap`, `_scene`, `_updatable?`, `_sideOrientation?`, `_instance?`): `Mesh`
...
> `static` **MergeMeshes**(`meshes`, `disposeSource?`, `allow32BitsIndices?`, `meshSubclass?`, `subdivideWithSubMeshes?`, `multiMultiMaterials?`): [`Nullable`](../type-aliases/Nullable.md)\<`Mesh`\>
