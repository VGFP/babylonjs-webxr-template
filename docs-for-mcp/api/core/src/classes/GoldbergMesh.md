...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / GoldbergMesh

# Class: GoldbergMesh

Defined in: [babylonjs-source/packages/dev/core/src/Meshes/goldbergMesh.pure.ts:62](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Meshes/goldbergMesh.pure.ts#L62)
...
> **goldbergData**: [`GoldbergData`](../type-aliases/GoldbergData.md)

Defined in: [babylonjs-source/packages/dev/core/src/Meshes/goldbergMesh.pure.ts:66](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Meshes/goldbergMesh.pure.ts#L66)
...
Defined in: [babylonjs-source/packages/dev/core/src/Meshes/mesh.pure.ts:3308](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Meshes/mesh.pure.ts#L3308)
...
[`Nullable`](../type-aliases/Nullable.md)\<[`Node`](Node.md)\> \| [`MeshCloneOptions`](../interfaces/MeshCloneOptions.md)
...
Defined in: [babylonjs-source/packages/dev/core/src/Meshes/mesh.pure.ts:3328](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Meshes/mesh.pure.ts#L3328)
...
Defined in: [babylonjs-source/packages/dev/core/src/Meshes/mesh.pure.ts:1057](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Meshes/mesh.pure.ts#L1057)
...
> **getFacetNormalToRef**(`i`, `ref`): `GoldbergMesh`
...
Defined in: [babylonjs-source/packages/dev/core/src/Meshes/goldbergMesh.pure.ts:222](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Meshes/goldbergMesh.pure.ts#L222)
...
Defines the mesh to position

##### face

`number`

Defines the face to position onto

##### position

[`Vector3`](Vector3.md)

Defines the position relative to the face we are positioning the mesh onto
...
Defined in: [babylonjs-source/packages/dev/core/src/Meshes/goldbergMesh.pure.ts:85](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Meshes/goldbergMesh.pure.ts#L85)
...
Defines the pole index or the shared face index if the fromPole parameter is passed in

##### fromPole?

`number`

Defines an optional pole index to find the related info from
...
> **renderWithRenderPassId**(`renderPassId?`, `enableAlphaMode?`, `effectiveMeshReplacement?`, `subMesh?`, `checkFrustumCulling?`): `GoldbergMesh`
...
Defined in: [babylonjs-source/packages/dev/core/src/Meshes/goldbergMesh.pure.ts:235](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Meshes/goldbergMesh.pure.ts#L235)
...
Defined in: [babylonjs-source/packages/dev/core/src/Meshes/goldbergMesh.pure.ts:133](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Meshes/goldbergMesh.pure.ts#L133)
...
the new color to apply to the mesh
...
Defined in: [babylonjs-source/packages/dev/core/src/Meshes/goldbergMesh.pure.ts:202](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Meshes/goldbergMesh.pure.ts#L202)
...
(`number` \| [`Vector2`](Vector2.md))[][]

the new UVs to apply to the mesh
...
If you pass a length (number), it is the number of elements to update. For example, if kind is "matrix" and you pass 2 as length, it will update 2 matrices (2*16 floats) in the GPU buffer starting from the offset; in this case [offset](#thininstancepartialbufferupdate) should also be expressed as a number of elements.
If you pass a Float32Array, [offset](#thininstancepartialbufferupdate) is interpreted in floats in the underlying GPU buffer, consistent with low-level buffer update methods such as updateDirectly.
...
the offset in the GPU buffer where to update the data:
 - when [dataOrLength](#thininstancepartialbufferupdate) is a number, this is an element offset (for example, a matrix index);
 - when [dataOrLength](#thininstancepartialbufferupdate) is a Float32Array, this is a float offset in the underlying buffer.
...
> **unfreezeWorldMatrix**(): `GoldbergMesh`
...
Defined in: [babylonjs-source/packages/dev/core/src/Meshes/goldbergMesh.pure.ts:142](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Meshes/goldbergMesh.pure.ts#L142)
...
Defined in: [babylonjs-source/packages/dev/core/src/Meshes/goldbergMesh.pure.ts:211](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Meshes/goldbergMesh.pure.ts#L211)
...
> `static` **Parse**(`parsedMesh`, `scene`): `GoldbergMesh`

Defined in: [babylonjs-source/packages/dev/core/src/Meshes/goldbergMesh.pure.ts:286](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Meshes/goldbergMesh.pure.ts#L286)
...
the scene to create the goldberg mesh in
