...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphGreaterThanOrEqualBlock

# Class: FlowGraphGreaterThanOrEqualBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:761](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L761)

Greater than or equal block.

## Extends

- `FlowGraphBinaryOperationBlock`\<`FlowGraphNumber`, `FlowGraphNumber`, `boolean`\>

## Constructors

### Constructor

> **new FlowGraphGreaterThanOrEqualBlock**(`config?`): `FlowGraphGreaterThanOrEqualBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:762](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L762)
...
`FlowGraphBinaryOperationBlock<FlowGraphNumber, FlowGraphNumber, boolean>.constructor`
...
> **b**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<`FlowGraphNumber`\>
