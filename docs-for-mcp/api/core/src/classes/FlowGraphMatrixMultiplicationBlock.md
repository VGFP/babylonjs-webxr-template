...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphMatrixMultiplicationBlock

# Class: FlowGraphMatrixMultiplicationBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMatrixMathBlocks.pure.ts:86](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMatrixMathBlocks.pure.ts#L86)

Multiplies two matrices.

## Extends

- `FlowGraphBinaryOperationBlock`\<`FlowGraphMatrix`, `FlowGraphMatrix`, `FlowGraphMatrix`\>

## Constructors

### Constructor

> **new FlowGraphMatrixMultiplicationBlock**(`config?`): `FlowGraphMatrixMultiplicationBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMatrixMathBlocks.pure.ts:92](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMatrixMathBlocks.pure.ts#L92)
...
`FlowGraphBinaryOperationBlock<FlowGraphMatrix, FlowGraphMatrix, FlowGraphMatrix>.constructor`
