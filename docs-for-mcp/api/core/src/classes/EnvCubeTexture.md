...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / EnvCubeTexture

# Abstract Class: EnvCubeTexture

Defined in: [babylonjs-source/packages/dev/core/src/Materials/Textures/envCubeTexture.pure.ts:23](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Materials/Textures/envCubeTexture.pure.ts#L23)
...
- [`EXRCubeTexture`](EXRCubeTexture.md)

## Constructors

### Constructor

> **new EnvCubeTexture**(`url`, `sceneOrEngine`, `size`, `noMipmap?`, `generateHarmonics?`, `gammaSpace?`, `prefilterOnLoad?`, `onLoad?`, `onError?`, `supersample?`, `prefilterIrradianceOnLoad?`, `prefilterUsingCdf?`, `sphericalPolynomialTargetSize?`): `EnvCubeTexture`

Defined in: [babylonjs-source/packages/dev/core/src/Materials/Textures/envCubeTexture.pure.ts:122](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Materials/Textures/envCubeTexture.pure.ts#L122)
...
The location of the raw data (Panorama stored in RGBE format)
...
Prefilters texture to allow use of this texture as a PBR reflection texture.
...
Prefilters texture to allow use of this texture for irradiance lighting.
...
> **onLoadObservable**: [`Observable`](Observable.md)\<`EnvCubeTexture`\>
...
Defined in: [babylonjs-source/packages/dev/core/src/Materials/Textures/envCubeTexture.pure.ts:192](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Materials/Textures/envCubeTexture.pure.ts#L192)
...
Defined in: [babylonjs-source/packages/dev/core/src/Materials/Textures/envCubeTexture.pure.ts:419](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Materials/Textures/envCubeTexture.pure.ts#L419)
