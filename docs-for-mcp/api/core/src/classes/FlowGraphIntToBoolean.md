...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphIntToBoolean

# Class: FlowGraphIntToBoolean

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Transformers/flowGraphTypeToTypeBlocks.pure.ts:40](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Transformers/flowGraphTypeToTypeBlocks.pure.ts#L40)

A block that converts an integer to a boolean.

## Extends

- `FlowGraphUnaryOperationBlock`\<[`FlowGraphInteger`](FlowGraphInteger.md), `boolean`\>

## Constructors

### Constructor

> **new FlowGraphIntToBoolean**(`config?`): `FlowGraphIntToBoolean`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Transformers/flowGraphTypeToTypeBlocks.pure.ts:41](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Transformers/flowGraphTypeToTypeBlocks.pure.ts#L41)
...
`FlowGraphUnaryOperationBlock<FlowGraphInteger, boolean>.constructor`
