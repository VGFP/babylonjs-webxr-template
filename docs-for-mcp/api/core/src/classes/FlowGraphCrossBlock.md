...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphCrossBlock

# Class: FlowGraphCrossBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:120](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L120)

Cross product block.

## Extends

- `FlowGraphBinaryOperationBlock`\<[`Vector3`](Vector3.md), [`Vector3`](Vector3.md), [`Vector3`](Vector3.md)\>

## Constructors

### Constructor

> **new FlowGraphCrossBlock**(`config?`): `FlowGraphCrossBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts:121](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphVectorMathBlocks.pure.ts#L121)
...
`FlowGraphBinaryOperationBlock<Vector3, Vector3, Vector3>.constructor`
