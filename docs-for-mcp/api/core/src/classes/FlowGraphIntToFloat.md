...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphIntToFloat

# Class: FlowGraphIntToFloat

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Transformers/flowGraphTypeToTypeBlocks.pure.ts:49](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Transformers/flowGraphTypeToTypeBlocks.pure.ts#L49)

A block that converts an integer to a float.

## Extends

- `FlowGraphUnaryOperationBlock`\<[`FlowGraphInteger`](FlowGraphInteger.md), `number`\>

## Constructors

### Constructor

> **new FlowGraphIntToFloat**(`config?`): `FlowGraphIntToFloat`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Transformers/flowGraphTypeToTypeBlocks.pure.ts:50](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Transformers/flowGraphTypeToTypeBlocks.pure.ts#L50)
...
`FlowGraphUnaryOperationBlock<FlowGraphInteger, number>.constructor`
