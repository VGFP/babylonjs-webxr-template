...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / GaussianSplattingMesh

# Class: GaussianSplattingMesh

Defined in: [babylonjs-source/packages/dev/core/src/Meshes/GaussianSplatting/gaussianSplattingMesh.ts:87](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Meshes/GaussianSplatting/gaussianSplattingMesh.ts#L87)
...
- [`GaussianSplattingCompoundMesh`](GaussianSplattingCompoundMesh.md)

## Constructors

### Constructor

> **new GaussianSplattingMesh**(`name`, `url?`, `scene?`, `keepInRam?`, `needsRotationScaleTextures?`): `GaussianSplattingMesh`

Defined in: [babylonjs-source/packages/dev/core/src/Meshes/GaussianSplatting/gaussianSplattingMesh.ts:122](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Meshes/GaussianSplatting/gaussianSplattingMesh.ts#L122)
...
`GaussianSplattingMeshBase.constructor`
...
`GaussianSplattingMeshBase.actionManager`
...
`GaussianSplattingMeshBase.alphaIndex`
...
`GaussianSplattingMeshBase.alwaysSelectAsActiveMesh`
...
`GaussianSplattingMeshBase.animations`
...
`GaussianSplattingMeshBase.cullingStrategy`
...
`GaussianSplattingMeshBase.customMarkAsDirty`
...
`GaussianSplattingMeshBase.decalMap`
...
`GaussianSplattingMeshBase.definedFacingForward`
...
`GaussianSplattingMeshBase.delayLoadingFile`
...
`GaussianSplattingMeshBase.delayLoadState`
...
`GaussianSplattingMeshBase.doNotSyncBoundingInfo`
...
`GaussianSplattingMeshBase.edgesColor`
...
`GaussianSplattingMeshBase.edgesRenderer`
...
`GaussianSplattingMeshBase.edgesShareWithInstances`
...
`GaussianSplattingMeshBase.edgesWidth`
...
`GaussianSplattingMeshBase.ellipsoid`
...
`GaussianSplattingMeshBase.ellipsoidOffset`
...
`GaussianSplattingMeshBase.enablePointerMoveEvents`
...
`GaussianSplattingMeshBase.forceRenderingWhenOccluded`
...
`GaussianSplattingMeshBase.ignoreCameraMaxZ`
...
`GaussianSplattingMeshBase.ignoreNonUniformScaling`
...
`GaussianSplattingMeshBase.inspectableCustomProperties`
...
`GaussianSplattingMeshBase.instancedBuffers`
...
`GaussianSplattingMeshBase.instances`
...
`GaussianSplattingMeshBase.isBlocker`
...
`GaussianSplattingMeshBase.isNearGrabbable`
...
`GaussianSplattingMeshBase.isNearPickable`
...
`GaussianSplattingMeshBase.isOccluded`
...
`GaussianSplattingMeshBase.isOcclusionQueryInProgress`
...
`GaussianSplattingMeshBase.isPickable`
...
`GaussianSplattingMeshBase.metadata`
...
`GaussianSplattingMeshBase.name`
...
`GaussianSplattingMeshBase.occlusionForRenderPassId`
...
`GaussianSplattingMeshBase.occlusionQueryAlgorithmType`
...
`GaussianSplattingMeshBase.occlusionRetryCount`
...
`GaussianSplattingMeshBase.occlusionType`
...
`GaussianSplattingMeshBase.onAccessibilityTagChangedObservable`
...
`GaussianSplattingMeshBase.onAfterWorldMatrixUpdateObservable`
...
`GaussianSplattingMeshBase.onCollideObservable`
...
`GaussianSplattingMeshBase.onCollisionPositionChangeObservable`
...
`GaussianSplattingMeshBase.onDisposeObservable`
...
`GaussianSplattingMeshBase.onLODLevelSelection`
...
`GaussianSplattingMeshBase.onMaterialChangedObservable`
...
`GaussianSplattingMeshBase.onMeshReadyObservable`
...
`GaussianSplattingMeshBase.onReady`
...
`GaussianSplattingMeshBase.onRebuildObservable`
...
`GaussianSplattingMeshBase.outlineColor`
...
`GaussianSplattingMeshBase.outlineWidth`
...
`GaussianSplattingMeshBase.overlayAlpha`
...
`GaussianSplattingMeshBase.overlayColor`
...
`GaussianSplattingMeshBase.physicsBody`
...
`GaussianSplattingMeshBase.physicsImpostor`
...
`GaussianSplattingMeshBase.reIntegrateRotationIntoRotationQuaternion`
...
`GaussianSplattingMeshBase.renderOutline`
...
`GaussianSplattingMeshBase.renderOverlay`
...
`GaussianSplattingMeshBase.reservedDataStore`
...
`GaussianSplattingMeshBase.scalingDeterminant`
...
`GaussianSplattingMeshBase.showBoundingBox`
...
`GaussianSplattingMeshBase.showSubMeshesBoundingBox`
...
`GaussianSplattingMeshBase.state`
...
`GaussianSplattingMeshBase.subMeshes`
...
`GaussianSplattingMeshBase.thinInstanceAllowAutomaticStaticBufferRecreation`
...
`GaussianSplattingMeshBase.thinInstanceCount`
...
`GaussianSplattingMeshBase.thinInstanceEnablePicking`
...
`GaussianSplattingMeshBase.uniqueId`
...
`GaussianSplattingMeshBase.useOctreeForCollisions`
...
`GaussianSplattingMeshBase.useOctreeForPicking`
...
`GaussianSplattingMeshBase.useOctreeForRenderingSelection`
...
`GaussianSplattingMeshBase.viewUpdateThreshold`
...
`GaussianSplattingMeshBase.BACKSIDE`
...
`GaussianSplattingMeshBase.BillboardUseParentOrientation`
...
`GaussianSplattingMeshBase.BOTTOM`
...
`GaussianSplattingMeshBase.CAP_ALL`
...
`GaussianSplattingMeshBase.CAP_END`
...
`GaussianSplattingMeshBase.CAP_START`
...
`GaussianSplattingMeshBase.CENTER`
...
`GaussianSplattingMeshBase.CULLINGSTRATEGY_BOUNDINGSPHERE_ONLY`
...
`GaussianSplattingMeshBase.CULLINGSTRATEGY_OPTIMISTIC_INCLUSION`
...
`GaussianSplattingMeshBase.CULLINGSTRATEGY_OPTIMISTIC_INCLUSION_THEN_BSPHERE_ONLY`
...
`GaussianSplattingMeshBase.CULLINGSTRATEGY_STANDARD`
...
`GaussianSplattingMeshBase.DefaultIsPickable`
...
`GaussianSplattingMeshBase.DEFAULTSIDE`
...
`GaussianSplattingMeshBase.DOUBLESIDE`
...
`GaussianSplattingMeshBase.FLIP_N_ROTATE_ROW`
...
`GaussianSplattingMeshBase.FLIP_N_ROTATE_TILE`
...
`GaussianSplattingMeshBase.FLIP_ROW`
...
`GaussianSplattingMeshBase.FLIP_TILE`
...
`GaussianSplattingMeshBase.FRONTSIDE`
...
`GaussianSplattingMeshBase.INSTANCEDMESH_SORT_TRANSPARENT`
...
`GaussianSplattingMeshBase.LEFT`
...
`GaussianSplattingMeshBase.NO_CAP`
...
`GaussianSplattingMeshBase.NO_FLIP`
...
`GaussianSplattingMeshBase.OCCLUSION_ALGORITHM_TYPE_ACCURATE`
...
`GaussianSplattingMeshBase.OCCLUSION_ALGORITHM_TYPE_CONSERVATIVE`
...
`GaussianSplattingMeshBase.OCCLUSION_TYPE_NONE`
...
`GaussianSplattingMeshBase.OCCLUSION_TYPE_OPTIMISTIC`
...
`GaussianSplattingMeshBase.OCCLUSION_TYPE_STRICT`
...
`GaussianSplattingMeshBase.ProgressiveUpdateAmount`
...
`GaussianSplattingMeshBase.RIGHT`
...
`GaussianSplattingMeshBase.ROTATE_ROW`
...
`GaussianSplattingMeshBase.ROTATE_TILE`
...
`GaussianSplattingMeshBase.absolutePosition`
...
`GaussianSplattingMeshBase.absoluteRotationQuaternion`
...
`GaussianSplattingMeshBase.absoluteScaling`
...
`GaussianSplattingMeshBase.accessibilityTag`
...
`GaussianSplattingMeshBase.animationPropertiesOverride`
...
`GaussianSplattingMeshBase.applyFog`
...
`GaussianSplattingMeshBase.areNormalsFrozen`
...
`GaussianSplattingMeshBase.bakedVertexAnimationManager`
...
`GaussianSplattingMeshBase.behaviors`
...
`GaussianSplattingMeshBase.billboardMode`
...
`GaussianSplattingMeshBase.centersTexture`
...
`GaussianSplattingMeshBase.checkCollisions`
...
`GaussianSplattingMeshBase.cloneMeshMap`
...
`GaussianSplattingMeshBase.collider`
...
`GaussianSplattingMeshBase.collisionGroup`
...
`GaussianSplattingMeshBase.collisionMask`
...
`GaussianSplattingMeshBase.collisionResponse`
...
`GaussianSplattingMeshBase.collisionRetryCount`
...
`GaussianSplattingMeshBase.colorsTexture`
...
`GaussianSplattingMeshBase.compensation`
...
`GaussianSplattingMeshBase.computeBonesUsingShaders`
...
`GaussianSplattingMeshBase.covariancesATexture`
...
`GaussianSplattingMeshBase.covariancesBTexture`
...
`GaussianSplattingMeshBase.disableDepthSort`
...
`GaussianSplattingMeshBase.doNotSerialize`
...
`GaussianSplattingMeshBase.enableDistantPicking`
...
`GaussianSplattingMeshBase.facetDepthSortFrom`
...
`GaussianSplattingMeshBase.facetNb`
...
`GaussianSplattingMeshBase.forcedInstanceCount`
...
`GaussianSplattingMeshBase.forceWorldMatrixInstancedBufferUpdate`
...
`GaussianSplattingMeshBase.forward`
...
`GaussianSplattingMeshBase.geometry`
...
`GaussianSplattingMeshBase.hasBoundingInfo`
...
`GaussianSplattingMeshBase.hasInstances`
...
`GaussianSplattingMeshBase.hasLODLevels`
...
`GaussianSplattingMeshBase.hasThinInstances`
...
`GaussianSplattingMeshBase.hasVertexAlpha`
...
`GaussianSplattingMeshBase.infiniteDistance`
...
`GaussianSplattingMeshBase.inheritVisibility`
...
`GaussianSplattingMeshBase.isAnInstance`
...
`GaussianSplattingMeshBase.isBlocked`
...
`GaussianSplattingMeshBase.isFacetDataEnabled`
...
`GaussianSplattingMeshBase.isUnIndexed`
...
`GaussianSplattingMeshBase.isVisible`
...
`GaussianSplattingMeshBase.isWorldMatrixFrozen`
...
`GaussianSplattingMeshBase.kernelSize`
...
`GaussianSplattingMeshBase.layerMask`
...
`GaussianSplattingMeshBase.lightSources`
...
`GaussianSplattingMeshBase.manualUpdateOfPreviousWorldMatrixInstancedBuffer`
...
`GaussianSplattingMeshBase.manualUpdateOfWorldMatrixInstancedBuffer`
...
`GaussianSplattingMeshBase.material`
...
`GaussianSplattingMeshBase.maxShDegree`
...
`GaussianSplattingMeshBase.morphTargetManager`
...
`GaussianSplattingMeshBase.mustDepthSortFacets`
...
`GaussianSplattingMeshBase.nonUniformScaling`
...
`GaussianSplattingMeshBase.numBoneInfluencers`
...
`GaussianSplattingMeshBase.onAfterRenderObservable`
...
`GaussianSplattingMeshBase.onBeforeBindObservable`
...
`GaussianSplattingMeshBase.onBeforeDraw`
...
`GaussianSplattingMeshBase.onBeforeDrawObservable`
...
`GaussianSplattingMeshBase.onBeforeRenderObservable`
...
`GaussianSplattingMeshBase.onBetweenPassObservable`
...
`GaussianSplattingMeshBase.onClonedObservable`
...
`GaussianSplattingMeshBase.onCollide`
...
`GaussianSplattingMeshBase.onCollisionPositionChange`
...
`GaussianSplattingMeshBase.onDispose`
...
`GaussianSplattingMeshBase.onEnabledStateChangedObservable`
...
`GaussianSplattingMeshBase.overrideMaterialSideOrientation`
...
`GaussianSplattingMeshBase.overridenInstanceCount`
...
`GaussianSplattingMeshBase.overrideRenderingFillMode`
...
`GaussianSplattingMeshBase.parent`
...
`GaussianSplattingMeshBase.partitioningBBoxRatio`
...
`GaussianSplattingMeshBase.partitioningSubdivisions`
...
`GaussianSplattingMeshBase.pointerOverDisableMeshTesting`
...
`GaussianSplattingMeshBase.position`
...
`GaussianSplattingMeshBase.previousWorldMatrixInstancedBuffer`
...
`GaussianSplattingMeshBase.rawBoundingInfo`
...
`GaussianSplattingMeshBase.receiveShadows`
...
`GaussianSplattingMeshBase.renderingGroupId`
...
`GaussianSplattingMeshBase.rotation`
...
`GaussianSplattingMeshBase.rotationQuaternion`
...
`GaussianSplattingMeshBase.rotationsATexture`
...
`GaussianSplattingMeshBase.rotationsBTexture`
...
`GaussianSplattingMeshBase.rotationScaleTexture`
...
`GaussianSplattingMeshBase.scaling`
...
`GaussianSplattingMeshBase.shData`
...
`GaussianSplattingMeshBase.shDegree`
...
`GaussianSplattingMeshBase.shTextures`
...
`GaussianSplattingMeshBase.sideOrientation`
...
`GaussianSplattingMeshBase.skeleton`
...
`GaussianSplattingMeshBase.source`
...
`GaussianSplattingMeshBase.splatCount`
...
`GaussianSplattingMeshBase.splatsData`
...
`GaussianSplattingMeshBase.surroundingMeshes`
...
`GaussianSplattingMeshBase.useBones`
...
`GaussianSplattingMeshBase.useLODScreenCoverage`
...
`GaussianSplattingMeshBase.useVertexColors`
...
`GaussianSplattingMeshBase.viewDirectionFactor`
...
`GaussianSplattingMeshBase.visibility`
...
`GaussianSplattingMeshBase.worldMatrixFromCache`
...
`GaussianSplattingMeshBase.worldMatrixInstancedBuffer`
...
`GaussianSplattingMeshBase.BILLBOARDMODE_ALL`
...
`GaussianSplattingMeshBase.BILLBOARDMODE_NONE`
...
`GaussianSplattingMeshBase.BILLBOARDMODE_USE_POSITION`
...
`GaussianSplattingMeshBase.BILLBOARDMODE_X`
...
`GaussianSplattingMeshBase.BILLBOARDMODE_Y`
...
`GaussianSplattingMeshBase.BILLBOARDMODE_Z`
...
`GaussianSplattingMeshBase._getCameraDirection`
...
`GaussianSplattingMeshBase._invalidateInstanceVertexArrayObject`
...
`GaussianSplattingMeshBase.addBehavior`
...
`GaussianSplattingMeshBase.addChild`
...
`GaussianSplattingMeshBase.addLODLevel`
...
Defined in: [babylonjs-source/packages/dev/core/src/Meshes/GaussianSplatting/gaussianSplattingMesh.ts:908](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Meshes/GaussianSplatting/gaussianSplattingMesh.ts#L908)
...
Use [GaussianSplattingCompoundMesh.addPart](GaussianSplattingCompoundMesh.md#addpart) instead.
...
`GaussianSplattingMeshBase.addRotation`
...
`GaussianSplattingMeshBase.alignWithNormal`
...
`GaussianSplattingMeshBase.applyAngularImpulse`
...
`GaussianSplattingMeshBase.applyDisplacementMap`
...
`GaussianSplattingMeshBase.applyDisplacementMapFromBuffer`
...
`GaussianSplattingMeshBase.applyImpulse`
...
`GaussianSplattingMeshBase.applySkeleton`
...
`GaussianSplattingMeshBase.applyTorque`
...
`GaussianSplattingMeshBase.attachToBone`
...
`GaussianSplattingMeshBase.bakeCurrentTransformIntoVertices`
...
`GaussianSplattingMeshBase.bakeTransformIntoVertices`
...
`GaussianSplattingMeshBase.beginAnimation`
...
`GaussianSplattingMeshBase.buildBoundingInfo`
...
`GaussianSplattingMeshBase.calcMovePOV`
...
`GaussianSplattingMeshBase.calcRotatePOV`
...
`GaussianSplattingMeshBase.cleanMatrixWeights`
...
`GaussianSplattingMeshBase.clone`
...
`GaussianSplattingMeshBase.computeWorldMatrix`
...
`GaussianSplattingMeshBase.convertToFlatShadedMesh`
...
`GaussianSplattingMeshBase.convertToUnIndexedMesh`
...
`GaussianSplattingMeshBase.copyVerticesData`
...
`GaussianSplattingMeshBase.createAnimationRange`
...
`GaussianSplattingMeshBase.createInstance`
...
`GaussianSplattingMeshBase.createNormals`
...
`GaussianSplattingMeshBase.createOrUpdateSubmeshesOctree`
...
`GaussianSplattingMeshBase.deleteAnimationRange`
...
`GaussianSplattingMeshBase.detachFromBone`
...
`GaussianSplattingMeshBase.directRender`
...
`GaussianSplattingMeshBase.disableEdgesRendering`
...
`GaussianSplattingMeshBase.disableFacetData`
...
`GaussianSplattingMeshBase.dispose`
...
`GaussianSplattingMeshBase.enableEdgesRendering`
...
`GaussianSplattingMeshBase.flipFaces`
...
`GaussianSplattingMeshBase.forceSharedVertices`
...
`GaussianSplattingMeshBase.freezeNormals`
...
`GaussianSplattingMeshBase.freezeWorldMatrix`
...
`GaussianSplattingMeshBase.getAbsolutePivotPoint`
...
`GaussianSplattingMeshBase.getAbsolutePivotPointToRef`
...
`GaussianSplattingMeshBase.getAbsolutePosition`
...
`GaussianSplattingMeshBase.getAnimatables`
...
`GaussianSplattingMeshBase.getAnimationByName`
...
`GaussianSplattingMeshBase.getAnimationRange`
...
`GaussianSplattingMeshBase.getAnimationRanges`
...
`GaussianSplattingMeshBase.getBehaviorByName`
...
`GaussianSplattingMeshBase.getBoundingInfo`
...
`GaussianSplattingMeshBase.getChildMeshes`
...
`GaussianSplattingMeshBase.getChildren`
...
`GaussianSplattingMeshBase.getChildTransformNodes`
...
`GaussianSplattingMeshBase.getClassName`
...
`GaussianSplattingMeshBase.getClosestFacetAtCoordinates`
...
`GaussianSplattingMeshBase.getClosestFacetAtLocalCoordinates`
...
`GaussianSplattingMeshBase.getConnectedParticleSystems`
...
`GaussianSplattingMeshBase.getDescendants`
...
`GaussianSplattingMeshBase.getDirection`
...
`GaussianSplattingMeshBase.getDirectionToRef`
...
`GaussianSplattingMeshBase.getDistanceToCamera`
...
`GaussianSplattingMeshBase.getEmittedParticleSystems`
...
`GaussianSplattingMeshBase.getEngine`
...
`GaussianSplattingMeshBase.getFacetDataParameters`
...
`GaussianSplattingMeshBase.getFacetLocalNormals`
...
`GaussianSplattingMeshBase.getFacetLocalPartitioning`
...
`GaussianSplattingMeshBase.getFacetLocalPositions`
...
`GaussianSplattingMeshBase.getFacetNormal`

***

### getFacetNormalToRef()

> **getFacetNormalToRef**(`i`, `ref`): `GaussianSplattingMesh`
...
`GaussianSplattingMeshBase.getFacetNormalToRef`
...
`GaussianSplattingMeshBase.getFacetPosition`
...
`GaussianSplattingMeshBase.getFacetPositionToRef`
...
`GaussianSplattingMeshBase.getFacetsAtLocalCoordinates`
...
`GaussianSplattingMeshBase.getHierarchyBoundingVectors`
...
`GaussianSplattingMeshBase.getHierarchyEmittedParticleSystems`
...
`GaussianSplattingMeshBase.getIndices`
...
`GaussianSplattingMeshBase.getLoadingPromise`
...
`GaussianSplattingMeshBase.getLOD`
...
`GaussianSplattingMeshBase.getLODLevelAtDistance`
...
`GaussianSplattingMeshBase.getLODLevels`
...
`GaussianSplattingMeshBase.getMaterialForRenderPass`
...
`GaussianSplattingMeshBase.getMeshUniformBuffer`
...
`GaussianSplattingMeshBase.getNormalsData`
...
`GaussianSplattingMeshBase.getPhysicsBody`
...
`GaussianSplattingMeshBase.getPhysicsImpostor`
...
`GaussianSplattingMeshBase.getPivotMatrix`
...
`GaussianSplattingMeshBase.getPivotPoint`
...
`GaussianSplattingMeshBase.getPivotPointToRef`
...
`GaussianSplattingMeshBase.getPoseMatrix`
...
`GaussianSplattingMeshBase.getPositionData`
...
`GaussianSplattingMeshBase.getPositionExpressedInLocalSpace`
...
`GaussianSplattingMeshBase.getPositionInCameraSpace`
...
`GaussianSplattingMeshBase.getRawBoundingInfo`
...
`GaussianSplattingMeshBase.getScene`
...
`GaussianSplattingMeshBase.getTotalIndices`
...
`GaussianSplattingMeshBase.getTotalVertices`
...
`GaussianSplattingMeshBase.getVertexBuffer`
...
`GaussianSplattingMeshBase.getVerticesData`
...
`GaussianSplattingMeshBase.getVerticesDataKinds`
...
`GaussianSplattingMeshBase.getWorldMatrix`
...
`GaussianSplattingMeshBase.increaseVertices`
...
`GaussianSplattingMeshBase.instantiateHierarchy`
...
`GaussianSplattingMeshBase.intersects`
...
`GaussianSplattingMeshBase.intersectsMesh`
...
`GaussianSplattingMeshBase.intersectsPoint`
...
`GaussianSplattingMeshBase.isCompletelyInFrustum`
...
`GaussianSplattingMeshBase.isDescendantOf`
...
`GaussianSplattingMeshBase.isDisposed`
...
`GaussianSplattingMeshBase.isEnabled`
...
`GaussianSplattingMeshBase.isInFrustum`
...
`GaussianSplattingMeshBase.isReady`
...
`GaussianSplattingMeshBase.isUsingPivotMatrix`
...
`GaussianSplattingMeshBase.isUsingPostMultiplyPivotMatrix`
...
`GaussianSplattingMeshBase.isVertexBufferUpdatable`
...
`GaussianSplattingMeshBase.isVerticesDataPresent`
...
`GaussianSplattingMeshBase.isWorldMatrixCameraDependent`
...
`GaussianSplattingMeshBase.loadDataAsync`
...
`GaussianSplattingMeshBase.loadFileAsync`
...
`GaussianSplattingMeshBase.locallyTranslate`
...
`GaussianSplattingMeshBase.lookAt`
...
`GaussianSplattingMeshBase.makeGeometryUnique`
...
`GaussianSplattingMeshBase.markAsDirty`
...
`GaussianSplattingMeshBase.markVerticesDataAsUpdatable`
...
`GaussianSplattingMeshBase.movePOV`
...
`GaussianSplattingMeshBase.moveWithCollisions`
...
`GaussianSplattingMeshBase.normalizeToUnitCube`
...
`GaussianSplattingMeshBase.optimizeIndices`
...
`GaussianSplattingMeshBase.optimizeIndicesAsync`
...
`GaussianSplattingMeshBase.refreshBoundingInfo`
...
`GaussianSplattingMeshBase.registerAfterRender`
...
`GaussianSplattingMeshBase.registerAfterWorldMatrixUpdate`
...
`GaussianSplattingMeshBase.registerBeforeRender`
...
`GaussianSplattingMeshBase.registerInstancedBuffer`
...
`GaussianSplattingMeshBase.releaseSubMeshes`
...
`GaussianSplattingMeshBase.removeBehavior`
...
`GaussianSplattingMeshBase.removeChild`
...
`GaussianSplattingMeshBase.removeLODLevel`
...
Defined in: [babylonjs-source/packages/dev/core/src/Meshes/GaussianSplatting/gaussianSplattingMesh.ts:921](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Meshes/GaussianSplatting/gaussianSplattingMesh.ts#L921)
...
Use [GaussianSplattingCompoundMesh.removePart](GaussianSplattingCompoundMesh.md#removepart) instead.
...
`GaussianSplattingMeshBase.removeVerticesData`
...
`GaussianSplattingMeshBase.render`

***

### renderWithRenderPassId()

> **renderWithRenderPassId**(`renderPassId?`, `enableAlphaMode?`, `effectiveMeshReplacement?`, `subMesh?`, `checkFrustumCulling?`): `GaussianSplattingMesh`
...
`GaussianSplattingMeshBase.renderWithRenderPassId`
...
`GaussianSplattingMeshBase.resetDrawCache`
...
`GaussianSplattingMeshBase.resetLocalMatrix`
...
`GaussianSplattingMeshBase.rotate`
...
`GaussianSplattingMeshBase.rotateAround`
...
`GaussianSplattingMeshBase.rotatePOV`
...
Defined in: [babylonjs-source/packages/dev/core/src/Meshes/GaussianSplatting/gaussianSplattingMesh.ts:1066](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Meshes/GaussianSplatting/gaussianSplattingMesh.ts#L1066)
...
`GaussianSplattingMeshBase.serialize`
...
`GaussianSplattingMeshBase.serializeAnimationRanges`
...
`GaussianSplattingMeshBase.setAbsolutePosition`
...
`GaussianSplattingMeshBase.setBoundingInfo`
...
`GaussianSplattingMeshBase.setDirection`
...
`GaussianSplattingMeshBase.setEnabled`
...
`GaussianSplattingMeshBase.setIndexBuffer`
...
`GaussianSplattingMeshBase.setIndices`
...
`GaussianSplattingMeshBase.setMaterialById`
...
`GaussianSplattingMeshBase.setMaterialForRenderPass`
...
`GaussianSplattingMeshBase.setNormalsForCPUSkinning`
...
`GaussianSplattingMeshBase.setParent`
...
`GaussianSplattingMeshBase.setPhysicsLinkWith`
...
`GaussianSplattingMeshBase.setPivotMatrix`
...
`GaussianSplattingMeshBase.setPivotPoint`
...
`GaussianSplattingMeshBase.setPositionsForCPUSkinning`
...
`GaussianSplattingMeshBase.setPositionWithLocalVector`
...
`GaussianSplattingMeshBase.setPreTransformMatrix`
...
`GaussianSplattingMeshBase.setVerticesBuffer`
...
`GaussianSplattingMeshBase.setVerticesData`
...
`GaussianSplattingMeshBase.simplify`
...
`GaussianSplattingMeshBase.subdivide`
...
`GaussianSplattingMeshBase.synchronizeInstances`
...
`GaussianSplattingMeshBase.thinInstanceAdd`
...
`GaussianSplattingMeshBase.thinInstanceAddSelf`
...
`GaussianSplattingMeshBase.thinInstanceBufferUpdated`
...
`GaussianSplattingMeshBase.thinInstanceGetWorldMatrices`
...
`GaussianSplattingMeshBase.thinInstancePartialBufferUpdate`
...
`GaussianSplattingMeshBase.thinInstanceRefreshBoundingInfo`
...
`GaussianSplattingMeshBase.thinInstanceRegisterAttribute`
...
`GaussianSplattingMeshBase.thinInstanceSetAttributeAt`
...
`GaussianSplattingMeshBase.thinInstanceSetBuffer`
...
`GaussianSplattingMeshBase.thinInstanceSetMatrixAt`
...
`GaussianSplattingMeshBase.toLeftHanded`
...
`GaussianSplattingMeshBase.toString`
...
`GaussianSplattingMeshBase.transferToEffect`
...
`GaussianSplattingMeshBase.translate`
...
`GaussianSplattingMeshBase.unfreezeNormals`

***

### unfreezeWorldMatrix()

> **unfreezeWorldMatrix**(): `GaussianSplattingMesh`
...
`GaussianSplattingMeshBase.unfreezeWorldMatrix`
...
`GaussianSplattingMeshBase.unregisterAfterRender`
...
`GaussianSplattingMeshBase.unregisterAfterWorldMatrixUpdate`
...
`GaussianSplattingMeshBase.unregisterBeforeRender`
...
`GaussianSplattingMeshBase.updateData`
...
`GaussianSplattingMeshBase.updateDataAsync`
...
`GaussianSplattingMeshBase.updateFacetData`
...
`GaussianSplattingMeshBase.updateIndices`
...
`GaussianSplattingMeshBase.updateMeshPositions`
...
`GaussianSplattingMeshBase.updatePoseMatrix`
...
`GaussianSplattingMeshBase.updateVerticesData`
...
`GaussianSplattingMeshBase.validateSkinning`
...
`GaussianSplattingMeshBase.AddNodeConstructor`
...
`GaussianSplattingMeshBase.Construct`
...
`GaussianSplattingMeshBase.ConvertPLYToSplat`
...
`GaussianSplattingMeshBase.ConvertPLYToSplatAsync`
...
`GaussianSplattingMeshBase.ConvertPLYWithSHToSplat`
...
`GaussianSplattingMeshBase.ConvertPLYWithSHToSplatAsync`
...
`GaussianSplattingMeshBase.CreateBox`
...
`GaussianSplattingMeshBase.CreateCapsule`
...
`GaussianSplattingMeshBase.CreateCylinder`
...
`GaussianSplattingMeshBase.CreateDashedLines`
...
`GaussianSplattingMeshBase.CreateDecal`
...
`GaussianSplattingMeshBase.CreateDisc`
...
`GaussianSplattingMeshBase.CreateGround`
...
`GaussianSplattingMeshBase.CreateGroundFromHeightMap`
...
`GaussianSplattingMeshBase.CreateHemisphere`
...
`GaussianSplattingMeshBase.CreateIcoSphere`
...
`GaussianSplattingMeshBase.CreateLathe`
...
`GaussianSplattingMeshBase.CreateLines`
...
`GaussianSplattingMeshBase.CreatePlane`
...
`GaussianSplattingMeshBase.CreatePolygon`
...
`GaussianSplattingMeshBase.CreatePolyhedron`
...
`GaussianSplattingMeshBase.CreateRibbon`
...
`GaussianSplattingMeshBase.CreateSphere`
...
`GaussianSplattingMeshBase.CreateTiledGround`
...
`GaussianSplattingMeshBase.CreateTorus`
...
`GaussianSplattingMeshBase.CreateTorusKnot`
...
`GaussianSplattingMeshBase.CreateTube`
...
`GaussianSplattingMeshBase.ExtendToGoldberg`
...
`GaussianSplattingMeshBase.ExtrudePolygon`
...
`GaussianSplattingMeshBase.ExtrudeShape`
...
`GaussianSplattingMeshBase.ExtrudeShapeCustom`
...
`GaussianSplattingMeshBase.MergeMeshes`
...
`GaussianSplattingMeshBase.MergeMeshesAsync`
...
`GaussianSplattingMeshBase.MinMax`

***

### Parse()

> `static` **Parse**(`parsedMesh`, `scene`): `GaussianSplattingMesh`

Defined in: [babylonjs-source/packages/dev/core/src/Meshes/GaussianSplatting/gaussianSplattingMesh.ts:1171](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/Meshes/GaussianSplatting/gaussianSplattingMesh.ts#L1171)
...
`GaussianSplattingMeshBase.Parse`
...
`GaussianSplattingMeshBase.ParseAnimationRanges`
...
`GaussianSplattingMeshBase.ParseHeader`
