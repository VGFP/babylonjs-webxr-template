...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / ThinPassPostProcess

# Class: ThinPassPostProcess

Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/thinPassPostProcess.ts:8](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/PostProcesses/thinPassPostProcess.ts#L8)
...
> **new ThinPassPostProcess**(`name`, `engine?`, `options?`): `ThinPassPostProcess`

Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/thinPassPostProcess.ts:31](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/PostProcesses/thinPassPostProcess.ts#L31)
...
> `readonly` `static` **FragmentUrl**: `"pass"` = `"pass"`

Defined in: [babylonjs-source/packages/dev/core/src/PostProcesses/thinPassPostProcess.ts:12](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/PostProcesses/thinPassPostProcess.ts#L12)
