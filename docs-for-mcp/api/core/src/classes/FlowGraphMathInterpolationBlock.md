...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphMathInterpolationBlock

# Class: FlowGraphMathInterpolationBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:674](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L674)

Interpolate block.

## Extends

- `FlowGraphTernaryOperationBlock`\<`FlowGraphMathOperationType`, `FlowGraphMathOperationType`, `FlowGraphMathOperationType`, `FlowGraphMathOperationType`\>

## Constructors

### Constructor

> **new FlowGraphMathInterpolationBlock**(`config?`): `FlowGraphMathInterpolationBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts:680](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/Math/flowGraphMathBlocks.pure.ts#L680)
...
`FlowGraphTernaryOperationBlock< FlowGraphMathOperationType, FlowGraphMathOperationType, FlowGraphMathOperationType, FlowGraphMathOperationType >.constructor`

## Properties

### a

> **a**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<`FlowGraphMathOperationType`\>

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphTernaryOperationBlock.ts:14](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphTernaryOperationBlock.ts#L14)
...
> **b**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<`FlowGraphMathOperationType`\>

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphTernaryOperationBlock.ts:18](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphTernaryOperationBlock.ts#L18)
...
> **c**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<`FlowGraphMathOperationType`\>

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphTernaryOperationBlock.ts:22](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphTernaryOperationBlock.ts#L22)
...
Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphTernaryOperationBlock.ts:44](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphTernaryOperationBlock.ts#L44)
...
Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphTernaryOperationBlock.ts:52](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/FlowGraph/Blocks/Data/flowGraphTernaryOperationBlock.ts#L52)
