...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FlowGraphKeyDownEventBlock

# Class: FlowGraphKeyDownEventBlock

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Event/flowGraphKeyDownEventBlock.ts:26](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Event/flowGraphKeyDownEventBlock.ts#L26)

A keyboard event block that fires when a key is pressed down.
Extends [FlowGraphKeyboardEventBlock](FlowGraphKeyboardEventBlock.md) with an `isRepeat` output
...
> **new FlowGraphKeyDownEventBlock**(`config?`): `FlowGraphKeyDownEventBlock`

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Event/flowGraphKeyDownEventBlock.ts:39](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Event/flowGraphKeyDownEventBlock.ts#L39)
...
> `readonly` **isRepeat**: [`FlowGraphDataConnection`](FlowGraphDataConnection.md)\<`boolean`\>

Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Event/flowGraphKeyDownEventBlock.ts:30](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Event/flowGraphKeyDownEventBlock.ts#L30)
...
Defined in: [babylonjs-source/packages/dev/core/src/FlowGraph/Blocks/Event/flowGraphKeyDownEventBlock.ts:65](https://github.com/BabylonJS/Babylon.js/blob/28caae20c63c6938ebffe216e1f3a0ce58f7ca0e/packages/dev/core/src/FlowGraph/Blocks/Event/flowGraphKeyDownEventBlock.ts#L65)
