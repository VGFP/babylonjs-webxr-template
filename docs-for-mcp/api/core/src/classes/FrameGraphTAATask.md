...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / FrameGraphTAATask
...
The thin post process to use for the Temporal Anti-Aliasing effect. If not provided, a new one will be created.
