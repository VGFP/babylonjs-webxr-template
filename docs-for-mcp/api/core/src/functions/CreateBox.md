...
[@babylonjs/root](../../../README.md) / [core/src](../README.md) / CreateBox

# Function: CreateBox()

> **CreateBox**(`name`, `options?`, `scene?`): [`Mesh`](../classes/Mesh.md)

Defined in: [babylonjs-source/packages/dev/core/src/Meshes/Builders/boxBuilder.pure.ts:237](https://github.com/BabylonJS/Babylon.js/blob/4d4dad2f008743af1de7c56c2cbe1a0c8879df33/packages/dev/core/src/Meshes/Builders/boxBuilder.pure.ts#L237)
